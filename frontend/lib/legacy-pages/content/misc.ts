...
export function buildLayananCopy(): LegacyRewriteCopy {
  return {
...
export function buildAboutCopy(): LegacyRewriteCopy {
  return {
...
export function buildAboutStatementCopy(): LegacyRewriteCopy {
  return {
...
export function buildContactCopy(): LegacyRewriteCopy {
  return {
...
export function buildPrivacyCopy(): LegacyRewriteCopy {
  return {
