...
function getDefaultServiceTypes(page: LegacyAstroPage) {
  if (page.section === "percetakan") {
    return [
      {
        title: "Cetak Promosi",
        description: "Banner, brosur, stiker, dan materi promosi untuk campaign bisnis.",
        href: "/percetakan",
      },
      {
        title: "Cetak Branding",
        description: "Kartu nama, company profile, kemasan produk, dan material corporate.",
        href: "/percetakan/cetak-company-profile",
      },
      {
        title: "Cetak Event",
        description: "Undangan, album, dan kebutuhan cetak acara dengan finishing terarah.",
