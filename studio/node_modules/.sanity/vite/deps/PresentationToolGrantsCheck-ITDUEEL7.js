...
} from "./chunk-SZ7VLAR3.js";
import {
  createCompatibilityActors
} from "./chunk-FAVN4EGH.js";
import {
  require_fast_deep_equal
} from "./chunk-L4S6DWB6.js";
import {
  createPreviewSecret,
  generateUrlSecret
} from "./chunk-HEJB2DK3.js";
import {
  API_VERSION,
  DEFAULT_TOOL_NAME,
  EDIT_INTENT_MODE,
...
// ../node_modules/.pnpm/sanity@5.19.0_@emotion+is-prop-valid@1.4.0_@noble+hashes@2.0.1_@oclif+core@4.10.4_@sani_8a83f85a1afb58e644ac725fa825ebf2/node_modules/sanity/lib/_chunks-es/PresentationToolGrantsCheck.js
...
// ../node_modules/.pnpm/@sanity+preview-url-secret@4.0.4_@sanity+client@7.20.0/node_modules/@sanity/preview-url-secret/dist/without-secret-search-params.js
...
// ../node_modules/.pnpm/@sanity+preview-url-secret@4.0.4_@sanity+client@7.20.0/node_modules/@sanity/preview-url-secret/dist/toggle-preview-access-sharing.js
...
// ../node_modules/.pnpm/@sanity+preview-url-secret@4.0.4_@sanity+client@7.20.0/node_modules/@sanity/preview-url-secret/dist/toggle-vercel-protection-bypass.js
...
var Root$1 = ut.div.withConfig({
  displayName: "Root",
  componentId: "sc-1auuvvr-0"
})`overflow:hidden;flex-basis:0;flex-shrink:1;`;
...
var PanelsWrapper = ut.div.withConfig({
  displayName: "PanelsWrapper",
  componentId: "sc-17hl5hb-0"
})`display:flex;flex-direction:row;height:100%;overflow:hidden;width:100%;`;
...
var RootLayout = ut(PaneLayout).withConfig({
...
})`& > div{min-width:none !important;max-width:none !important;}`;
var WrappedCode$1 = ut(Code).withConfig({
...
var WrappedCode = ut(Code).withConfig({
  displayName: "WrappedCode",
...
var Resizer = ut.div.withConfig({
  displayName: "Resizer",
  componentId: "sc-1ov4oxw-0"
})`position:relative;`;
var ResizerInner = ut.div.withConfig({
...
var IFrameElement = motion.create(ut.iframe.withConfig({
  displayName: "IFrameElement",
  componentId: "sc-yizz5y-0"
})`box-shadow:0 0 0 1px var(--card-border-color);border:0;max-height:100%;width:100%;view-transition-class:presentation-tool-iframe;`);
var IFrameOverlay = ut(Box).withConfig({
  displayName: "IFrameOverlay",
  componentId: "sc-yizz5y-1"
})`position:absolute;inset:0;background:transparent;`;
var GlobalViewTransition = ht`
...
var QRCodeSVG = (0, import_react2.lazy)(() => import("./QRCodeSVG-4SSPVPXP.js"));
var QrCodeLogoSize = 24;
var QrCodeLogoPadding = 16;
var QrSize = 224;
var StyledSanityMonogram = ut(SanityMonogram).withConfig({
  displayName: "StyledSanityMonogram",
  componentId: "sc-wa94k4-0"
})`position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);height:${QrCodeLogoSize}px;width:${QrCodeLogoSize}px;`;
...
var LiveQueries = (0, import_react2.lazy)(() => import("./LiveQueries-XYPYSET7.js"));
var PostMessageDocuments = (0, import_react2.lazy)(() => import("./PostMessageDocuments-P4NL33IY.js"));
var PostMessageRefreshMutations = (0, import_react2.lazy)(() => import("./PostMessageRefreshMutations-QJRNJMTG.js"));
var PostMessagePerspective = (0, import_react2.lazy)(() => import("./PostMessagePerspective-4YKJKK3V.js"));
var PostMessagePreviewSnapshots = (0, import_react2.lazy)(() => import("./PostMessagePreviewSnapshots-VWYZNESF.js"));
var PostMessageSchema = (0, import_react2.lazy)(() => import("./PostMessageSchema-QTPXLMIW.js"));
var PostMessageTelemetry = (0, import_react2.lazy)(() => import("./PostMessageTelemetry-CWF2RARP.js"));
var Container2 = ut(Flex).withConfig({
...
function defineResolveAllowPatternsActor({
  ...
  return fromPromise(async ({
    ...
    if (typeof URLPattern > "u" && await import("./urlpattern-polyfill-6MULBSTX.js"), !allowOption)
...
//# sourceMappingURL=PresentationToolGrantsCheck-ITDUEEL7.js.map
