...
// ../node_modules/.pnpm/sanity@5.19.0_@emotion+is-prop-valid@1.4.0_@noble+hashes@2.0.1_@oclif+core@4.10.4_@sani_8a83f85a1afb58e644ac725fa825ebf2/node_modules/sanity/lib/_chunks-es/presentation.js
...
var presentationUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources8-NL7VXNR6.js")
});
...
function LocationsBanner(props) {
  ...
  let t5;
  $[20] !== documentId || $[21] !== expanded || $[22] !== isResolving || $[23] !== locations || $[24] !== locationsCount || $[25] !== options || $[26] !== presentation || $[27] !== presentationName || $[28] !== schemaType || $[29] !== showPresentationTitle || $[30] !== title || $[31] !== toggle ? (t5 = locations && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsx)(Stack, { hidden: !expanded, marginTop: 1, space: 1, children: locations.map((l) => {
      let active = false;
      return (options.name || DEFAULT_TOOL_NAME) === presentationName && presentation?.params.preview && (active = areUrlsMatching(presentation.params.preview, l.href)), (0, import_jsx_runtime.jsx)(LocationItem, { active, documentId, documentType: schemaType.name, node: l, toolName: options.name || DEFAULT_TOOL_NAME }, l.href);
    }) })
...
function LocationItem(props) {
  ...
  let t5;
  $[13] !== Icon ? (t5 = (0, import_jsx_runtime.jsx)(Box, { flex: "none", children: (0, import_jsx_runtime.jsx)(Text, { size: 1, children: (0, import_jsx_runtime.jsx)(Icon, {}) }) }), $[13] = Icon, $[14] = t5) : t5 = $[14];
  let t6;
  $[15] !== node.title ? (t6 = (0, import_jsx_runtime.jsx)(Text, { size: 1, weight: "medium", children: node.title }), $[15] = node.title, $[16] = t6) : t6 = $[16];
  let t7;
  $[17] !== node.href || $[18] !== node.showHref ? (t7 = node.showHref !== false && (0, import_jsx_runtime.jsx)(Text, { muted: true, size: 1, textOverflow: "ellipsis", children: node.href }), $[17] = node.href, $[18] = node.showHref, $[19] = t7) : t7 = $[19];
  let t8;
  $[20] !== t6 || $[21] !== t7 ? (t8 = (0, import_jsx_runtime.jsxs)(Stack, { flex: 1, space: 2, children: [
    t6,
    t7
  ] }), $[20] = t6, $[21] = t7, $[22] = t8) : t8 = $[22];
  let t9;
  $[23] !== t5 || $[24] !== t8 ? (t9 = (0, import_jsx_runtime.jsxs)(Flex, { gap: 3, children: [
    t5,
    t8
  ] }), $[23] = t5, $[24] = t8, $[25] = t9) : t9 = $[25];
  let t10;
  return $[26] !== active || $[27] !== node.href || $[28] !== t3 || $[29] !== t4 || $[30] !== t9 ? (t10 = (0, import_jsx_runtime.jsx)(Card, { ...t3, as: "a", onClick: t4, padding: 3, radius: 1, pressed: active, tone: "inherit", children: t9 }, node.href), $[26] = active, $[27] = node.href, $[28] = t3, $[29] = t4, $[30] = t9, $[31] = t10) : t10 = $[31], t10;
}
...
var LocationStack = ut.div.withConfig({
...
function PresentationDocumentHeader(props) {
  ...
  if ($[4] !== contextOptions || $[5] !== documentId || $[6] !== resolvers || $[7] !== schemaType || $[8] !== version) {
    ...
    t1 = $[9];
  let t2;
  return $[16] !== t1 ? (t2 = (0, import_jsx_runtime.jsx)(FormRow, { children: (0, import_jsx_runtime.jsx)(LocationStack, { children: t1 }) }), $[16] = t1, $[17] = t2) : t2 = $[17], t2;
}
function _temp$1(o) {
...
var PresentationTool = (0, import_react.lazy)(() => import("./PresentationToolGrantsCheck-ITDUEEL7.js"));
var BroadcastDisplayedDocument = (0, import_react.lazy)(() => import("./BroadcastDisplayedDocument-76C7EQQL.js"));
...
//# sourceMappingURL=chunk-UF6QCTHP.js.map
