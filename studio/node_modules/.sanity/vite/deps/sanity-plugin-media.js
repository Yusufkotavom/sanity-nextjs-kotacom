...
import "./chunk-PL5TQWPV.js";
import "./chunk-SH3HS3ET.js";
import "./chunk-3CJ6L2TA.js";
import "./chunk-Z2PYR4DL.js";
import {
  AddIcon,
  ArrowDownIcon,
  ArrowUpIcon,
  ...
  ut,
  white
} from "./chunk-3ZVCNXKR.js";
import "./chunk-BRE7IFDH.js";
import "./chunk-OKZEHT5I.js";
import {
  require_react_dom
} from "./chunk-6EEA7UTI.js";
import {
  require_jsx_runtime
...
// ../node_modules/.pnpm/sanity-plugin-media@4.1.1_@emotion+is-prop-valid@1.4.0_@types+react@19.2.14_react-dom@1_39da49a9a28da21fefe91143f77b3132/node_modules/sanity-plugin-media/dist/index.mjs
...
function isArrayIndex(value) {
  const n3 = +value;
  return Number.isInteger(n3) && String(n3) === value;
}
...
var hasMatchFunction = (v3) => {
  return v3 && typeof v3.match === "function";
};
...
// ../node_modules/.pnpm/@tanem+react-nprogress@5.0.63_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanem/react-nprogress/dist/react-nprogress.esm.js
...
function _objectSpread$2(e2) {
  for (var r3 = 1; r3 < arguments.length; r3++) {
    ...
    r3 % 2 ? ownKeys$2(Object(t3), true).forEach(function(r4) {
      _defineProperty(e2, r4, t3[r4]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(t3)) : ownKeys$2(Object(t3)).forEach(function(r4) {
...
var useUpdate = function useUpdate2() {
  var _useState = (0, import_react.useState)(0), _useState2 = _slicedToArray(_useState, 2), setState = _useState2[1];
  return (0, import_react.useCallback)(function() {
    return setState(incrementParameter);
  }, []);
};
var useGetSetState = function useGetSetState2() {
  var initialState4 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  var update = useUpdate();
  var state = (0, import_react.useRef)(_objectSpread$2({}, initialState4));
  var get3 = (0, import_react.useCallback)(function() {
    return state.current;
  }, []);
  var set3 = (0, import_react.useCallback)(function(patch) {
    if (!patch) {
      return;
    }
...
function _objectSpread$1(e2) {
  for (var r3 = 1; r3 < arguments.length; r3++) {
    var t3 = null != arguments[r3] ? arguments[r3] : {};
    r3 % 2 ? ownKeys$1(Object(t3), true).forEach(function(r4) {
      _defineProperty(e2, r4, t3[r4]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(t3)) : ownKeys$1(Object(t3)).forEach(function(r4) {
      Object.defineProperty(e2, r4, Object.getOwnPropertyDescriptor(t3, r4));
    });
  }
  return e2;
...
var useNProgress = function useNProgress2() {
  ...
  var set3 = (0, import_react.useCallback)(function(n3) {
    var _queue$current4;
    n3 = clamp(n3, minimum, 1);
    if (n3 === 1) {
      var _queue$current2, _queue$current3;
      cleanup();
      (_queue$current2 = queue.current) === null || _queue$current2 === void 0 || _queue$current2.enqueue(function(next2) {
        setState({
          progress: n3,
          sideEffect: function sideEffect2() {
            var _timeout$current2;
            return (_timeout$current2 = timeout.current) === null || _timeout$current2 === void 0 ? void 0 : _timeout$current2.schedule(next2, animationDuration);
          }
        });
      });
    ...
    (_queue$current4 = queue.current) === null || _queue$current4 === void 0 || _queue$current4.enqueue(function(next2) {
      setState({
        isFinished: false,
        progress: n3,
        sideEffect: function sideEffect2() {
          var _timeout$current3;
          return (_timeout$current3 = timeout.current) === null || _timeout$current3 === void 0 ? void 0 : _timeout$current3.schedule(next2, animationDuration);
        }
      });
    });
  }, [animationDuration, cleanup, minimum, queue, setState, timeout]);
  var trickle = (0, import_react.useCallback)(function() {
    set3(increment(get3().progress));
  }, [get3, set3]);
  var start = (0, import_react.useCallback)(function() {
    var _work = function work() {
      var _queue$current5;
      trickle();
      (_queue$current5 = queue.current) === null || _queue$current5 === void 0 || _queue$current5.enqueue(function(next2) {
        var _timeout$current4;
        (_timeout$current4 = timeout.current) === null || _timeout$current4 === void 0 || _timeout$current4.schedule(function() {
          _work();
          next2();
        }, incrementDuration);
      });
  ...
  var sideEffect = get3().sideEffect;
  (0, import_react.useEffect)(function() {
  ...
  }, [isAnimating, set3, setState, start]);
  return {
    animationDuration,
    isFinished: get3().isFinished,
    progress: get3().progress
  };
};
...
// ../node_modules/.pnpm/react-select@5.10.2_@types+react@19.2.14_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-select/dist/useStateManager-7e1e8489.esm.js
...
// ../node_modules/.pnpm/react-select@5.10.2_@types+react@19.2.14_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-select/dist/react-select.esm.js
...
function _createClass(e2, r3, t3) {
  return r3 && _defineProperties(e2.prototype, r3), t3 && _defineProperties(e2, t3), Object.defineProperty(e2, "prototype", {
    writable: false
  }), e2;
}
...
function _createSuper(t3) {
  ...
  return function() {
    var e2, o3 = _getPrototypeOf(t3);
    if (r3) {
      var s3 = _getPrototypeOf(this).constructor;
      e2 = Reflect.construct(o3, arguments, s3);
    } else e2 = o3.apply(this, arguments);
...
// ../node_modules/.pnpm/react-select@5.10.2_@types+react@19.2.14_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-select/dist/Select-ef7c0426.esm.js
...
function ruleset(value, root, parent, index2, offset, rules, points, type, props, children, length2) {
  ...
  for (var i3 = 0, j3 = 0, k2 = 0; i3 < index2; ++i3)
    for (var x2 = 0, y2 = substr(value, post + 1, post = abs(j3 = points[i3])), z = value; x2 < size; ++x2)
      if (z = trim(j3 > 0 ? rule[x2] + " " + y2 : replace(y2, /&\f/g, rule[x2])))
        props[k2++] = z;
...
// ../node_modules/.pnpm/@babel+runtime@7.29.2/node_modules/@babel/runtime/helpers/esm/taggedTemplateLiteral.js
...
// ../node_modules/.pnpm/react-select@5.10.2_@types+react@19.2.14_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-select/dist/index-641ee5b8.esm.js
...
var Select = (function(_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function renderPlaceholderOrValue() {
      ...
      return React4.createElement(SingleValue4, _extends({}, commonProps, {
        data: singleValue,
        isDisabled
    ...
    value: function renderMenu() {
      ...
      if (this.hasOptions()) {
        ...
        menuUI = React4.createElement(NoOptionsMessage4, commonProps, _message);
      }
      ...
      var menuElement = React4.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        ...
        return React4.createElement(Menu5, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
...
// ../node_modules/.pnpm/react-virtuoso@4.18.3_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-virtuoso/dist/index.mjs
...
function $(...t3) {
  ...
  let n3 = 0, o3 = null;
  const r3 = 2 ** t3.length - 1;
  return t3.forEach((s3, i3) => {
    const l2 = 2 ** i3;
    Y(s3, (c2) => {
      const d2 = n3;
      n3 |= l2, e2[i3] = c2, d2 !== r3 && n3 === r3 && o3 && (o3(), o3 = null);
    });
  }), (s3) => (i3) => {
    const l2 = () => {
      s3([i3].concat(e2));
...
function Io(t3) {
  ...
  return function(r3, s3) {
    switch (r3) {
      case Wt:
        return s3 ? n3 === s3 ? void 0 : (o3(), n3 = s3, e2 = Y(t3, s3), e2) : (o3(), Xt);
      case Zt:
        o3(), n3 = null;
        return;
    }
...
function vt(t3) {
  return ye(U(), (e2) => L(t3, e2));
}
function j(t3, e2 = [], { singleton: n3 } = { singleton: true }) {
  return {
    constructor: t3,
    dependencies: e2,
    id: xo(),
...
function at(...t3) {
  const e2 = U(), n3 = new Array(t3.length);
  let o3 = 0;
  const r3 = 2 ** t3.length - 1;
  return t3.forEach((s3, i3) => {
    const l2 = 2 ** i3;
    Y(s3, (c2) => {
      n3[i3] = c2, o3 |= l2, o3 === r3 && _(e2, n3);
    });
  }), function(s3, i3) {
    switch (s3) {
      case Zt: {
...
var Gt = j(
  () => {
    const t3 = v(ft.ERROR);
    return {
      log: v((n3, o3, r3 = ft.INFO) => {
        const s3 = vo().VIRTUOSO_LOG_LEVEL ?? it2(t3);
        r3 >= s3 && console[To[r3]](
...
function _e(t3, e2, n3) {
  ...
  const s3 = import_react10.default.useMemo(() => typeof ResizeObserver < "u" ? new ResizeObserver((i3) => {
    const l2 = () => {
...
function zn(t3, e2, n3, o3, r3, s3, i3, l2, c2) {
  const d2 = import_react10.default.useCallback(
    (m2) => {
      const x2 = Co(m2.children, e2, l2 ? "offsetWidth" : "offsetHeight", r3);
      let p2 = m2.parentElement;
      for (; p2.dataset.virtuosoScroller === void 0; )
        p2 = p2.parentElement;
      const T = p2.lastElementChild.dataset.viewportType === "window";
      let w3;
      T && (w3 = p2.ownerDocument.defaultView);
      const R = i3 ? l2 ? i3.scrollLeft : i3.scrollTop : T ? l2 ? w3.scrollX || w3.document.documentElement.scrollLeft : w3.scrollY || w3.document.documentElement.scrollTop : l2 ? p2.scrollLeft : p2.scrollTop, h2 = i3 ? l2 ? i3.scrollWidth : i3.scrollHeight : T ? l2 ? w3.document.documentElement.scrollWidth : w3.document.documentElement.scrollHeight : l2 ? p2.scrollWidth : p2.scrollHeight, f2 = i3 ? l2 ? i3.offsetWidth : i3.offsetHeight : T ? l2 ? w3.innerWidth : w3.innerHeight : l2 ? p2.offsetWidth : p2.offsetHeight;
      o3({
        scrollHeight: h2,
...
function Co(t3, e2, n3, o3) {
  ...
  for (let i3 = 0; i3 < r3; i3++) {
    ...
    if (l2.dataset.index === void 0)
      continue;
    const c2 = parseInt(l2.dataset.index), d2 = parseFloat(l2.dataset.knownSize), m2 = e2(l2, n3);
    if (m2 === 0 && o3("Zero-sized element, this should not happen", { child: l2 }, ft.ERROR), m2 === d2)
      continue;
    const x2 = s3[s3.length - 1];
    s3.length === 0 || x2.size !== m2 || x2.endIndex !== c2 - 1 ? s3.push({ endIndex: c2, size: m2, startIndex: c2 }) : s3[s3.length - 1].endIndex++;
  }
  return s3;
}
function fn(t3, e2, n3) {
  return e2 !== "normal" && e2?.endsWith("px") !== true && n3(`${t3} was not resolved to pixel value correctly`, e2, ft.WARN), e2 === "normal" ? 0 : parseInt(e2 ?? "0", 10);
}
function Ne(t3, e2, n3) {
  const o3 = import_react10.default.useRef(null), r3 = import_react10.default.useCallback(
    (c2) => {
      if (!c2?.offsetParent)
        return;
      const d2 = c2.getBoundingClientRect(), m2 = d2.width;
      let x2, p2;
      if (e2) {
        const T = e2.getBoundingClientRect(), w3 = d2.top - T.top;
        p2 = T.height - Math.max(0, w3), x2 = w3 + e2.scrollTop;
      } else {
        const T = i3.current.ownerDocument.defaultView;
        p2 = T.innerHeight - Math.max(0, d2.top), x2 = d2.top + T.scrollY;
      }
      o3.current = {
        offsetTop: x2,
        visibleHeight: p2,
  ...
  return import_react10.default.useEffect(() => {
    if (e2) {
      ...
      return d2.observe(e2), () => {
        e2.removeEventListener("scroll", l2), d2.unobserve(e2);
      };
    }
    const c2 = i3.current?.ownerDocument.defaultView;
    return c2?.addEventListener("scroll", l2), c2?.addEventListener("resize", l2), () => {
      c2?.removeEventListener("scroll", l2), c2?.removeEventListener("resize", l2);
    };
  }, [l2, e2, i3]), s3;
}
var It = j(
  () => {
    const t3 = U(), e2 = U(), n3 = v(0), o3 = U(), r3 = v(0), s3 = U(), i3 = U(), l2 = v(0), c2 = v(0), d2 = v(0), m2 = v(0), x2 = U(), p2 = U(), T = v(false), w3 = v(false), R = v(false);
    return L(
      I(
        t3,
        B(({ scrollTop: h2 }) => h2)
      ...
      I(
        t3,
        B(({ scrollHeight: h2 }) => h2)
      ),
      i3
    ), L(e2, r3), {
      deviation: n3,
      fixedFooterHeight: d2,
...
function ie(t3, e2) {
  if (!J(t3))
    return e2 === t3.k ? t3.v : e2 < t3.k ? ie(t3.l, e2) : ie(t3.r, e2);
}
function Rt(t3, e2, n3 = "k") {
  if (J(t3))
    return [-1 / 0, void 0];
  if (Number(t3[n3]) === e2)
    return [t3.k, t3.v];
  if (Number(t3[n3]) < e2) {
    const o3 = Rt(t3.r, e2, n3);
    return o3[0] === -1 / 0 ? [t3.k, t3.v] : o3;
  }
  return Rt(t3.l, e2, n3);
}
function Tt(t3, e2, n3) {
  return J(t3) ? Wn(e2, n3, 1) : e2 === t3.k ? dt(t3, { k: e2, v: n3 }) : e2 < t3.k ? mn(dt(t3, { l: Tt(t3.l, e2, n3) })) : mn(dt(t3, { r: Tt(t3.r, e2, n3) }));
}
function qt() {
  return se;
}
...
function Fe(t3, e2) {
  ...
  if (e2 === n3) {
    ...
    if (J(r3))
      return o3;
    const [s3, i3] = Pn(o3);
    return Se(dt(t3, { k: s3, l: Vn(o3), v: i3 }));
  }
  return e2 < n3 ? Se(dt(t3, { l: Fe(o3, e2) })) : Se(dt(t3, { r: Fe(r3, e2) }));
}
function _t(t3) {
...
function Se(t3) {
  ...
  if (He(t3))
    return Pe(dt(t3, { lvl: n3 - 1 }));
  if (!J(o3) && !J(o3.l)) {
    const r3 = o3.l, s3 = He(r3) ? o3.lvl - 1 : o3.lvl;
    return dt(r3, {
      l: dt(t3, {
        lvl: n3 - 1,
        r: r3.l
...
function Vn(t3) {
  return J(t3.r) ? t3.l : Se(dt(t3, { r: Vn(t3.r) }));
}
function He(t3) {
  return J(t3) || t3.lvl > t3.r.lvl;
}
function Pn(t3) {
  return J(t3.r) ? [t3.k, t3.v] : Pn(t3.r);
}
function Wn(t3, e2, n3, o3 = se, r3 = se) {
...
function Gn(t3) {
  const { l: e2 } = t3;
  return !J(e2) && e2.lvl === t3.lvl ? dt(e2, { r: dt(t3, { l: e2.r }) }) : t3;
}
function Pe(t3) {
  const { lvl: e2, r: n3 } = t3;
  return !J(n3) && !J(n3.r) && n3.lvl === e2 && n3.r.lvl === e2 ? dt(n3, { l: dt(t3, { r: n3.l }), lvl: e2 + 1 }) : t3;
}
function wo(t3) {
...
function Mn(t3, e2, n3) {
  return t3[ve(t3, e2, n3)];
}
function ve(t3, e2, n3, o3 = 0) {
  let r3 = t3.length - 1;
  for (; o3 <= r3; ) {
...
function yo(t3, e2, n3, o3) {
  const r3 = ve(t3, e2, o3), s3 = ve(t3, n3, o3, r3);
...
function Ro(t3, e2) {
  ...
  for (const o3 of e2) {
    ...
    const l2 = Yt(t3, i3 - 1, r3 + 1);
    if (l2.some(zo(o3)))
      continue;
    let c2 = false, d2 = false;
    for (const { end: m2, start: x2, value: p2 } of l2)
      c2 ? (r3 >= x2 || s3 === p2) && (t3 = Fe(t3, x2)) : (d2 = p2 !== s3, c2 = true), m2 > r3 && r3 >= x2 && p2 !== s3 && (t3 = Tt(t3, r3 + 1, p2));
    d2 && (t3 = Tt(t3, i3, s3));
  }
  return [t3, n3];
}
...
function Ho({ offset: t3 }, e2) {
  return e2 === t3 ? 0 : e2 < t3 ? -1 : 1;
}
function ce(t3, e2, n3) {
  if (e2.length === 0)
    return 0;
  const { index: o3, offset: r3, size: s3 } = Mn(e2, t3, $e), i3 = t3 - o3, l2 = s3 * i3 + (i3 - 1) * n3 + r3;
...
function Bo(t3, e2, n3, o3 = 0) {
  return o3 > 0 && (e2 = Math.max(e2, Mn(t3, o3, $e).offset)), Fn(yo(t3, e2, n3, Ho), Lo);
}
function Oo(t3, [e2, n3, o3, r3]) {
  e2.length > 0 && o3("received item sizes", e2, ft.DEBUG);
  const s3 = t3.sizeTree;
  let i3 = s3, l2 = 0;
  if (n3.length > 0 && J(s3) && e2.length === 2) {
    const p2 = e2[0].size, T = e2[1].size;
    i3 = n3.reduce((w3, R) => Tt(Tt(w3, R, p2), R + 1, T), i3);
  } else
    [i3, l2] = Ro(i3, e2);
  if (i3 === s3)
    return t3;
  const { lastIndex: c2, lastOffset: d2, lastSize: m2, offsetTree: x2 } = We(t3.offsetTree, l2, i3, r3);
  return {
    groupIndices: n3,
    groupOffsetTree: n3.reduce((p2, T) => Tt(p2, T, ce(T, x2, r3)), qt()),
    lastIndex: c2,
    lastOffset: d2,
    lastSize: m2,
    offsetTree: x2,
...
function ko(t3) {
  return _t(t3).map(({ k: e2, v: n3 }, o3, r3) => {
    const s3 = r3[o3 + 1];
    return { endIndex: s3 !== void 0 ? s3.k - 1 : 1 / 0, size: n3, startIndex: e2 };
  });
}
function pn(t3, e2) {
  let n3 = 0, o3 = 0;
...
function We(t3, e2, n3, o3) {
  let r3 = t3, s3 = 0, i3 = 0, l2 = 0, c2 = 0;
  if (e2 !== 0) {
    c2 = ve(r3, e2 - 1, $e), l2 = r3[c2].offset;
    const m2 = Rt(n3, e2 - 1);
    s3 = m2[0], i3 = m2[1], r3.length && r3[c2].size === Rt(n3, e2)[1] && (c2 -= 1), r3 = r3.slice(0, c2 + 1);
  } else
    r3 = [];
  for (const { start: d2, value: m2 } of Yt(n3, e2, 1 / 0)) {
    const x2 = d2 - s3, p2 = x2 * i3 + l2 + x2 * o3;
    r3.push({
      index: d2,
      offset: p2,
      size: m2
...
var Lt = j(
  ([{ log: t3 }, { recalcInProgress: e2 }]) => {
    const n3 = U(), o3 = U(), r3 = ht2(o3, 0), s3 = U(), i3 = U(), l2 = v(0), c2 = v([]), d2 = v(void 0), m2 = v(void 0), x2 = v(void 0), p2 = v(void 0), T = v((u2, g2) => Et(u2, Fo[g2])), w3 = v(void 0), R = v(0), h2 = bo(), f2 = ht2(
      I(n3, $(c2, t3, R), Ot(Oo, h2), et()),
      h2
    ), a2 = ht2(
      I(
        c2,
        et(),
        Ot((u2, g2) => ({ current: g2, prev: u2.current }), {
          current: [],
          prev: []
        }),
        B(({ prev: u2 }) => u2)
    ...
    L(
      I(
        ...
        $(f2, R),
        B(([u2, g2, C]) => {
          const z = u2.reduce((O2, V, N2) => Tt(O2, V, ce(V, g2.offsetTree, C) || N2), qt());
          return {
            ...g2,
            groupIndices: u2,
            groupOffsetTree: z
      ...
      I(
        o3,
        $(f2),
        W(([u2, { lastIndex: g2 }]) => u2 < g2),
        B(([u2, { lastIndex: g2, lastSize: C }]) => [
          {
            endIndex: g2,
            size: C,
            startIndex: u2
    ...
    L(
      I(
        m2,
        W((u2) => u2 !== void 0 && J(it2(f2).sizeTree)),
        B((u2) => {
          const g2 = it2(x2), C = it2(c2).length > 0;
          return g2 !== void 0 && g2 !== 0 ? C ? [
            { endIndex: 0, size: g2, startIndex: 0 },
      ...
      I(
        p2,
        W((u2) => u2 !== void 0 && u2.length > 0 && J(it2(f2).sizeTree)),
        B((u2) => {
          const g2 = [];
          let C = u2[0], z = 0;
          for (let O2 = 1; O2 < u2.length; O2++) {
            const V = u2[O2];
            V !== C && (g2.push({
              endIndex: O2 - 1,
              size: C,
      ...
      I(
        c2,
        $(x2, m2),
        W(([, u2, g2]) => u2 !== void 0 && g2 !== void 0),
        B(([u2, g2, C]) => {
          const z = [];
          for (let O2 = 0; O2 < u2.length; O2++) {
            const V = u2[O2], N2 = u2[O2 + 1];
            z.push({
              startIndex: V,
              endIndex: V,
              size: g2
    ...
    Y(
      I(
        l2,
        Ot(
          (u2, g2) => ({ diff: u2.prev - g2, prev: g2 }),
          { diff: 0, prev: 0 }
        ),
        B((u2) => u2.diff)
      ),
      (u2) => {
        const { groupIndices: g2 } = it2(f2);
        if (u2 > 0)
          _(e2, true), _(s3, u2 + pn(u2, g2));
        else if (u2 < 0) {
          const C = it2(a2);
          C.length > 0 && (u2 -= pn(-u2, C)), _(i3, u2);
        }
      }
    ), Y(I(l2, $(t3)), ([u2, g2]) => {
      u2 < 0 && g2(
    ...
    L(
      I(
        ...
        $(f2),
        B(([u2, g2]) => {
          const C = g2.groupIndices.length > 0, z = [], O2 = g2.lastSize;
          if (C) {
            const V = ie(g2.sizeTree, 0);
            let N2 = 0, Z = 0;
            for (; N2 < u2; ) {
              const q = g2.groupIndices[Z], Q = g2.groupIndices.length === Z + 1 ? 1 / 0 : g2.groupIndices[Z + 1] - q - 1;
              z.push({
                endIndex: q,
                size: V,
                startIndex: q
            ...
            const F = _t(g2.sizeTree);
            return N2 !== u2 && F.shift(), F.reduce(
              (q, { k: Q, v: gt }) => {
                let ut2 = q.ranges;
                return q.prevSize !== 0 && (ut2 = [
                  ...q.ranges,
                  {
                    endIndex: Q + u2 - 1,
                    size: q.prevSize,
          ...
          return _t(g2.sizeTree).reduce(
            (V, { k: N2, v: Z }) => ({
              prevIndex: N2 + u2,
              prevSize: Z,
              ranges: [...V.ranges, { endIndex: N2 + u2 - 1, size: V.prevSize, startIndex: V.prevIndex }]
            }),
            {
              prevIndex: 0,
              prevSize: O2,
      ...
      I(
        ...
        B(([u2, g2, C]) => {
          if (g2.groupIndices.length > 0) {
            ...
            if (V = _t(g2.sizeTree).reduce((Q, { k: gt, v: ut2 }) => Tt(Q, Math.max(0, gt + u2), ut2), V), Z !== -u2) {
              const Q = ie(g2.sizeTree, mt);
              V = Tt(V, 0, Q);
              const gt = Rt(g2.sizeTree, -u2 + 1)[1];
              V = Tt(V, 1, gt);
            }
            return {
              ...g2,
              sizeTree: V,
              ...We(g2.offsetTree, 0, V, C)
            };
          }
          const O2 = _t(g2.sizeTree).reduce((V, { k: N2, v: Z }) => Tt(V, Math.max(0, N2 + u2), Z), qt());
          return {
            ...g2,
            sizeTree: O2,
            ...We(g2.offsetTree, 0, O2, C)
          };
        })
      ),
      f2
...
var Dn = j(
  ([{ groupIndices: t3, sizes: e2, totalCount: n3 }, { headerHeight: o3, scrollTop: r3 }]) => {
    const s3 = U(), i3 = U(), l2 = vt(I(s3, B(Vo)));
    return L(
      I(
        l2,
        B((c2) => c2.totalCount)
      ...
      I(
        at(r3, e2, o3),
        W(([c2, d2]) => be(d2)),
        B(([c2, d2, m2]) => Rt(d2.groupOffsetTree, Math.max(c2 - m2, 0), "v")[0]),
        et(),
        B((c2) => [c2])
      ),
      i3
...
var At = j(
  ([{ log: t3 }]) => {
    ...
    return Y(e2, (o3) => {
      o3 && it2(t3)("props updated", {}, ft.DEBUG);
...
function $n(t3) {
  ...
  return e2.align || (e2.align = "start"), (!e2.behavior || !Po) && (e2.behavior = "auto"), e2.offset === void 0 && (e2.offset = 0), e2;
}
var fe = j(
  ([
    ...
    const T = U(), w3 = U(), R = v(0);
    let h2 = null, f2 = null, a2 = null;
    function S3() {
      h2 !== null && (h2(), h2 = null), a2 !== null && (a2(), a2 = null), f2 && (clearTimeout(f2), f2 = null), _(c2, false);
    }
    return L(
      I(
        T,
        ...
        B(
          ([
            [E, y2, k2, u2, g2, C, z, O2],
            V,
            N2,
            Z
          ]) => {
            const F = $n(E), { align: mt, behavior: q, offset: Q } = F, gt = u2 - 1, ut2 = Nn(F, y2, gt);
            let xt = ce(ut2, y2.offsetTree, V) + C;
            mt === "end" ? (xt += N2 + Rt(y2.sizeTree, ut2)[1] - k2 + Z, ut2 === gt && (xt += z)) : mt === "center" ? xt += (N2 + Rt(y2.sizeTree, ut2)[1] - k2 + Z) / 2 : xt -= g2, Q !== void 0 && Q !== 0 && (xt += Q);
            const Ft = (pt) => {
              S3(), pt ? (O2("retrying to scroll to", { location: E }, ft.DEBUG), _(T, E)) : (_(w3, true), O2("list did not change, scroll successful", {}, ft.DEBUG));
            };
            if (S3(), q === "smooth") {
              let pt = false;
              a2 = Y(e2, (Kt) => {
              ...
              h2 = yt(I(e2, Wo(150)), Ft);
            return f2 = setTimeout(() => {
              S3();
            }, 1200), _(c2, true), O2("scrolling from index to", { behavior: q, index: ut2, top: xt }, ft.DEBUG), { behavior: q, top: xt };
          }
        )
      ),
      d2
...
var me = j(
  ([{ defaultItemSize: t3, listRefresh: e2, sizes: n3 }, { scrollTop: o3 }, { scrollTargetReached: r3, scrollToIndex: s3 }, { didMount: i3 }]) => {
    const l2 = v(true), c2 = v(0), d2 = v(true);
    return L(
      I(
        i3,
        $(c2),
      ...
      I(
        at(e2, i3),
        $(l2, n3, t3, d2),
        W(([[, m2], x2, { sizeTree: p2 }, T, w3]) => m2 && (!J(p2) || Ae(T)) && !x2 && !w3),
        $(c2)
      ),
      ([, m2]) => {
        yt(r3, () => {
      ...
      initialItemFinalLocationReached: d2,
...
var Mo = 0;
var pe = j(([{ footerHeight: t3, headerHeight: e2, scrollBy: n3, scrollContainerState: o3, scrollTop: r3, viewportHeight: s3 }]) => {
  const i3 = v(false), l2 = v(true), c2 = U(), d2 = U(), m2 = v(4), x2 = v(Mo), p2 = ht2(
    I(
      ze(I(P(r3), $t(1), Bt(true)), I(P(r3), $t(1), Bt(false), dn(100))),
      et()
    ),
    false
  ), T = ht2(
    I(ze(I(n3, Bt(true)), I(n3, Bt(false), dn(200))), et()),
    false
  );
  L(
    I(
  ...
  const w3 = vt(
    I(
      at(o3, P(s3), P(e2), P(t3), P(m2)),
      Ot((a2, [{ scrollHeight: S3, scrollTop: E }, y2, k2, u2, g2]) => {
        const C = E + y2 - S3 > -g2, z = {
          scrollHeight: S3,
          scrollTop: E,
          viewportHeight: y2
        };
        if (C) {
          let V, N2;
          return E > a2.state.scrollTop ? (V = "SCROLLED_DOWN", N2 = a2.state.scrollTop - E) : (V = "SIZE_DECREASED", N2 = a2.state.scrollTop - E || a2.scrollTopDelta), {
            atBottom: true,
            atBottomBecause: V,
            scrollTopDelta: N2,
            state: z
        ...
        let O2;
        return z.scrollHeight > a2.state.scrollHeight ? O2 = "SIZE_INCREASED" : y2 < a2.state.viewportHeight ? O2 = "VIEWPORT_HEIGHT_DECREASING" : E < a2.state.scrollTop ? O2 = "SCROLLING_UPWARDS" : O2 = "NOT_FULLY_SCROLLED_TO_LAST_ITEM_BOTTOM", {
          atBottom: false,
          notAtBottomBecause: O2,
          state: z
        };
      }, Ao),
      et((a2, S3) => a2 !== void 0 && a2.atBottom === S3.atBottom)
    )
  ), R = ht2(
    I(
      o3,
      Ot(
        (a2, { scrollHeight: S3, scrollTop: E, viewportHeight: y2 }) => {
          if (!Un(a2.scrollHeight, S3)) {
            const k2 = S3 - (E + y2) < 1;
            return a2.scrollTop !== E && k2 ? {
              changed: true,
              jump: a2.scrollTop - E,
              scrollHeight: S3,
              scrollTop: E
  ...
  L(
    I(
      ...
      et(),
      Ot(
        (a2, S3) => it2(T) ? { direction: a2.direction, prevScrollTop: S3 } : { direction: S3 < a2.prevScrollTop ? ue : ne, prevScrollTop: S3 },
        { direction: ne, prevScrollTop: 0 }
      ),
      B((a2) => a2.direction)
    ),
    h2
  ), L(I(o3, zt(50), Bt(Go)), h2);
  const f2 = v(0);
  return L(
    I(
      p2,
...
function gn(t3, e2, n3) {
  return typeof t3 == "number" ? n3 === ue && e2 === ae || n3 === ne && e2 === de ? t3 : 0 : n3 === ue ? e2 === ae ? t3.main : t3.reverse : e2 === de ? t3.main : t3.reverse;
}
function In(t3, e2) {
  return typeof t3 == "number" ? t3 : t3[e2] ?? 0;
}
var je = j(
  ([{ deviation: t3, fixedHeaderHeight: e2, headerHeight: n3, scrollTop: o3, viewportHeight: r3 }]) => {
    const s3 = U(), i3 = v(0), l2 = v(0), c2 = v(0), d2 = ht2(
      I(
        at(
          P(o3),
          P(r3),
        ...
        B(
          ([
            ...
            const E = m2 - a2, y2 = h2 + f2, k2 = Math.max(p2 - E, 0);
            let u2 = hn;
            const g2 = In(S3, ae), C = In(S3, de);
            return T -= a2, T += p2 + f2, w3 += p2 + f2, w3 -= a2, T > m2 + y2 - g2 && (u2 = ue), w3 < m2 - k2 + x2 + C && (u2 = ne), u2 !== hn ? [
              Math.max(E - p2 - gn(R, ae, u2) - g2, 0),
              E - k2 - f2 + x2 + gn(R, de, u2) + C
            ] : null;
          }
        ),
        W((m2) => m2 !== null),
...
function _o(t3, e2, n3) {
  if (be(e2)) {
    const o3 = _n(t3, e2);
    return [
      { index: Rt(e2.groupOffsetTree, o3)[0], offset: 0, size: 0 },
      { data: n3?.[0], index: o3, offset: 0, size: 0 }
    ];
  }
  return [{ data: n3?.[0], index: t3, offset: 0, size: 0 }];
}
var Be = {
  bottom: 0,
  firstItemIndex: 0,
...
function Te(t3, e2, n3, o3, r3, s3) {
  const { lastIndex: i3, lastOffset: l2, lastSize: c2 } = r3;
  let d2 = 0, m2 = 0;
  if (t3.length > 0) {
    d2 = t3[0].offset;
    const R = t3[t3.length - 1];
    m2 = R.offset + R.size;
  }
  const x2 = n3 - i3, p2 = l2 + x2 * c2 + (x2 - 1) * o3, T = d2, w3 = p2 - m2;
  return {
    bottom: m2,
    firstItemIndex: s3,
    items: xn(t3, r3, s3),
    ...
    offsetTop: d2,
    top: T,
    topItems: xn(e2, r3, s3),
    topListHeight: e2.reduce((R, h2) => h2.size + R, 0),
    totalCount: n3
  };
}
function Kn(t3, e2, n3, o3, r3, s3) {
  let i3 = 0;
  ...
  const l2 = t3 + i3, c2 = Ke(e2, l2), d2 = Array.from({ length: l2 }).map((m2, x2) => ({
    data: s3[x2 + c2],
    index: x2 + c2,
    offset: 0,
    size: 0
  }));
  return Te(d2, [], l2, r3, n3, o3);
}
function xn(t3, e2, n3) {
  if (t3.length === 0)
    return [];
  if (!be(e2))
    return t3.map((d2) => ({ ...d2, index: d2.index + n3, originalIndex: d2.index }));
  const o3 = t3[0].index, r3 = t3[t3.length - 1].index, s3 = [], i3 = Yt(e2.groupOffsetTree, o3, r3);
  let l2, c2 = 0;
  for (const d2 of t3) {
    (!l2 || l2.end < d2.index) && (l2 = i3.shift(), c2 = e2.groupIndices.indexOf(l2.start));
    let m2;
    d2.index === l2.start ? m2 = {
      index: c2,
      type: "group"
    } : m2 = {
      groupIndex: c2,
      index: d2.index - (c2 + 1) + n3
    }, s3.push({
      ...m2,
      data: d2.data,
      offset: d2.offset,
      originalIndex: d2.index,
      size: d2.size
    });
  }
  return s3;
...
function Sn(t3, e2) {
  return t3 === void 0 ? 0 : typeof t3 == "number" ? t3 : t3[e2] ?? 0;
}
var Ut = j(
  ([
    ...
    { initialTopMostItemIndex: d2, scrolledToInitialItem: m2 },
    { topListHeight: x2 },
    p2,
    { didMount: T },
    { recalcInProgress: w3 }
  ]) => {
    const R = v([]), h2 = v(0), f2 = U(), a2 = v(0);
    L(s3.topItemsIndexes, R);
    const S3 = ht2(
      I(
        at(
          T,
        ...
        B(
          ([
            ...
            const Q = z, { offsetTree: gt, sizeTree: ut2 } = Q, xt = it2(h2);
            if (C === 0)
              return { ...Be, totalCount: C };
            if (u2 === 0 && g2 === 0)
              return xt === 0 ? { ...Be, totalCount: C } : Kn(xt, O2, z, Z, F, q || []);
            if (J(ut2))
              return xt > 0 ? null : Te(
                _o(Ke(O2, C), Q, q),
                [],
            ...
            const Ft = [];
            if (N2.length > 0) {
              const D = N2[0], K = N2[N2.length - 1];
              let rt = 0;
              for (const tt of Yt(ut2, D, K)) {
            ...
            const pt = N2.length > 0 ? N2[N2.length - 1] + 1 : 0, Kt = Bo(gt, u2, g2, pt);
            if (Kt.length === 0)
              return null;
    ...
    const E = vt(
      I(
        S3,
        W(({ items: u2 }) => u2.length > 0),
        $(r3, t3),
        W(([{ items: u2 }, g2]) => u2[u2.length - 1].originalIndex === g2 - 1),
        B(([, u2, g2]) => [u2 - 1, g2]),
        et(le),
        B(([u2]) => u2)
      )
      ...
      I(
        S3,
        zt(200),
        W(({ items: u2, topItems: g2 }) => u2.length > 0 && u2[0].originalIndex === g2.length),
      ...
      I(
        ...
        W(({ items: u2 }) => u2.length > 0),
        B(({ items: u2 }) => {
          let g2 = 0, C = u2.length - 1;
          for (; u2[g2].type === "group" && g2 < C; )
            g2++;
          for (; u2[C].type === "group" && C > g2; )
            C--;
          return {
            endIndex: u2[C].index,
            startIndex: u2[g2].index
          };
        }),
        et(An)
      )
...
var jn = j(
  ([{ fixedFooterHeight: t3, fixedHeaderHeight: e2, footerHeight: n3, headerHeight: o3 }, { listState: r3 }]) => {
    const s3 = U(), i3 = ht2(
      I(
        at(n3, t3, o3, e2, r3),
        B(([l2, c2, d2, m2, x2]) => l2 + c2 + d2 + m2 + x2.offsetBottom + x2.bottom)
      ),
      0
    );
    return L(P(i3), s3), { totalListHeight: i3, totalListHeightChanged: s3 };
  },
  ot(It, Ut),
  { singleton: true }
);
var No = j(
  ([{ viewportHeight: t3 }, { totalListHeight: e2 }]) => {
    const n3 = v(false), o3 = ht2(
      I(
        at(n3, t3, e2),
        W(([r3]) => r3),
        B(([, r3, s3]) => Math.max(0, r3 - s3)),
        zt(0),
        et()
      ),
      0
...
var Do = ({
  ...
  viewportBottom: s3,
  viewportTop: i3
}) => e2 < i3 ? { ...r3, align: n3 ?? "start", ...o3 !== void 0 ? { behavior: o3 } : {} } : t3 > s3 ? { ...r3, align: n3 ?? "end", ...o3 !== void 0 ? { behavior: o3 } : {} } : null;
var Yn = j(
  ([
    ...
    return L(
      I(
        m2,
        $(e2, c2, n3, s3, r3, o3, l2),
        $(t3),
        B(([[x2, p2, T, w3, R, h2, f2, a2], S3]) => {
          const { calculateViewLocation: E = Do, done: y2, ...k2 } = x2, u2 = Nn(x2, p2, w3 - 1), g2 = ce(u2, p2.offsetTree, S3) + R + h2, C = g2 + Rt(p2.sizeTree, u2)[1], z = a2 + h2, O2 = a2 + T - f2, V = E({
            itemBottom: C,
            itemTop: g2,
            locationParams: k2,
            viewportBottom: O2,
...
function Tn(t3) {
  return t3 === false ? false : t3 === "smooth" ? "smooth" : "auto";
}
var $o = (t3, e2) => typeof t3 == "function" ? Tn(t3(e2)) : e2 && Tn(t3);
var Uo = j(
  ([
    ...
    { scrollToIndex: i3 },
    { scrolledToInitialItem: l2 },
    { didMount: c2, propsReady: d2 },
    { log: m2 },
    { scrollingInProgress: x2 },
    { context: p2 },
    { scrollIntoView: T }
  ]) => {
    const w3 = v(false), R = U();
    let h2 = null;
    function f2(y2) {
      _(i3, {
        align: "end",
    ...
    Y(
      I(
        ...
        B(([[y2, k2], u2, g2, C, z]) => {
          let O2 = k2 && C, V = "auto";
          return O2 && (V = $o(u2, g2 || z), O2 = O2 && V !== false), { followOutputBehavior: V, shouldFollow: O2, totalCount: y2 };
        }),
        W(({ shouldFollow: y2 }) => y2)
      ),
      ({ followOutputBehavior: y2, totalCount: k2 }) => {
        h2 !== null && (h2(), h2 = null), it2(n3) !== void 0 ? requestAnimationFrame(() => {
          it2(m2)("following output to ", { totalCount: k2 }, ft.DEBUG), f2(y2);
        }) : h2 = yt(t3, () => {
          it2(m2)("following output to ", { totalCount: k2 }, ft.DEBUG), f2(y2), h2 = null;
        });
      }
    );
    function a2(y2) {
      const k2 = yt(r3, (u2) => {
        y2 && !u2.atBottom && u2.notAtBottomBecause === "SIZE_INCREASED" && h2 === null && (it2(m2)("scrolling to bottom due to increased size", {}, ft.DEBUG), f2("auto"));
      });
      setTimeout(k2, 100);
    }
    Y(
      I(
        ...
        W(([y2, , k2]) => y2 !== false && k2),
        Ot(
          ({ value: y2 }, [, k2]) => ({ refreshed: y2 === k2, value: k2 }),
      ...
      y2 !== false && !k2.atBottom && k2.notAtBottomBecause === "VIEWPORT_HEIGHT_DECREASING" && f2("auto");
    });
    const S3 = v(null), E = U();
    return L(
      ze(
      ...
      I(
        at(I(E, $t(1)), c2),
        $(P(S3), l2, x2, p2),
        B(([[y2, k2], u2, g2, C, z]) => k2 && g2 && u2?.({ context: z, totalCount: y2, scrollingInProgress: C })),
        W((y2) => !!y2),
        zt(0)
      ),
      (y2) => {
        h2 !== null && (h2(), h2 = null), it2(n3) !== void 0 ? requestAnimationFrame(() => {
          it2(m2)("scrolling into view", {}), _(T, y2);
        }) : h2 = yt(t3, () => {
          it2(m2)("scrolling into view", {}), _(T, y2), h2 = null;
        });
      }
    ), { autoscrollToBottom: R, followOutput: w3, scrollIntoViewOnChange: S3 };
  },
  ot(
    Lt,
    pe,
...
var Ko = j(
  ([{ data: t3, firstItemIndex: e2, gap: n3, sizes: o3 }, { initialTopMostItemIndex: r3 }, { initialItemCount: s3, listState: i3 }, { didMount: l2 }]) => (L(
    I(
      l2,
      $(s3),
      W(([, c2]) => c2 !== 0),
      $(r3, o3, e2, n3, t3),
      B(([[, c2], d2, m2, x2, p2, T = []]) => Kn(c2, d2, m2, x2, p2, T))
    ),
    i3
  ), {}),
  ot(Lt, me, Ut, At),
...
var Zn = j(
  ([{ scrollVelocity: t3 }]) => {
    const e2 = v(false), n3 = U(), o3 = v(false);
    return L(
      I(
        t3,
        $(o3, e2, n3),
        W(([r3, s3]) => s3 !== false && s3 !== void 0),
        B(([r3, s3, i3, l2]) => {
          const { enter: c2, exit: d2 } = s3;
          if (i3) {
            if (d2(r3, l2))
              return false;
          } else if (c2(r3, l2))
      ...
      I(at(e2, t3, n3), $(o3)),
      ([[r3, s3, i3], l2]) => {
        r3 && l2 !== false && l2 !== void 0 && l2.change && l2.change(s3, i3);
      }
...
var qe = j(([{ scrollContainerState: t3, scrollTo: e2 }]) => {
  const n3 = U(), o3 = U(), r3 = U(), s3 = v(false), i3 = v(void 0);
  return L(
    I(
      at(n3, o3),
      B(([{ scrollHeight: l2, scrollTop: c2, viewportHeight: d2 }, { offsetTop: m2 }]) => ({
        scrollHeight: l2,
...
var qo = j(
  ([
    ...
    const d2 = U(), m2 = v(void 0), x2 = v(null), p2 = v(null);
    return L(l2, x2), L(c2, p2), Y(
      I(
        d2,
        $(e2, o3, i3, x2, p2, n3)
      ),
      ([T, w3, R, h2, f2, a2, S3]) => {
        const E = ko(w3.sizeTree);
        h2 && f2 !== null && a2 !== null && (R = f2.scrollTop - a2.offsetTop), R -= S3, T({ ranges: E, scrollTop: R });
      }
    ), L(I(m2, W(Ae), B(Yo)), r3), L(
      I(
        s3,
        $(m2),
        W(([, T]) => T !== void 0),
...
var Zo = j(([{ topItemsIndexes: t3 }]) => {
  const e2 = v(0);
  return L(
    I(
      e2,
      W((n3) => n3 >= 0),
      B((n3) => Array.from({ length: n3 }).map((o3, r3) => r3))
    ),
    t3
  ), { topItemCount: e2 };
}, ot(Ut));
...
var Jo = j(
  ([
    ...
    { listState: c2 },
    { beforeUnshiftWith: d2, gap: m2, shiftWithOffset: x2, sizes: p2 },
    { log: T },
    { recalcInProgress: w3 }
  ]) => {
    const R = vt(
      I(
        ...
        $(i3),
        Ot(
          ([, f2, a2, S3], [{ bottom: E, items: y2, offsetBottom: k2, totalCount: u2 }, g2]) => {
            const C = E + k2;
            let z = 0;
            return a2 === u2 && f2.length > 0 && y2.length > 0 && (y2[0].originalIndex === 0 && f2[0].originalIndex === 0 || (z = C - S3, z !== 0 && (z += g2))), [z, y2, u2, C];
          },
          [0, [], 0, 0]
        ),
        W(([f2]) => f2 !== 0),
        $(o3, l2, n3, r3, T, w3),
        W(([, f2, a2, S3, , , E]) => !E && !S3 && f2 !== 0 && a2 === ue),
        B(([[f2], , , , , a2]) => (a2("Upward scrolling compensation", { amount: f2 }, ft.DEBUG), f2))
      )
    );
    function h2(f2) {
      f2 > 0 ? (_(e2, { behavior: "auto", top: -f2 }), _(t3, 0)) : (_(t3, 0), _(e2, { behavior: "auto", top: -f2 }));
    }
    return Y(I(R, $(t3, s3)), ([f2, a2, S3]) => {
      S3 && Xo() ? _(t3, a2 - f2) : h2(-f2);
    }), Y(
      I(
        at(ht2(s3, false), t3, w3),
        W(([f2, a2, S3]) => !f2 && !S3 && a2 !== 0),
        B(([f2, a2]) => a2),
        zt(1)
      ),
      h2
      ...
      I(
        d2,
        $(p2, m2),
        B(([f2, { groupIndices: a2, lastSize: S3, sizeTree: E }, y2]) => {
          function k2(O2) {
            return O2 * (S3 + y2);
          }
          if (a2.length === 0)
          ...
          for (; C < f2; ) {
            C++, u2 += g2;
            let O2 = a2.length === z + 1 ? 1 / 0 : a2[z + 1] - a2[z] - 1;
            C + O2 > f2 && (u2 -= g2, O2 = f2 - C + 1), C += O2, u2 += k2(O2), z++;
          }
          return u2;
        })
      ),
      (f2) => {
        _(t3, f2), requestAnimationFrame(() => {
          _(e2, { top: f2 }), requestAnimationFrame(() => {
            _(t3, 0), _(w3, false);
          });
        });
      }
  ...
  ([
    {
      ...
      sizeRanges: d2,
      sizes: m2,
      statefulTotalCount: x2,
      totalCount: p2,
      trackItemSizes: T
    },
    { initialItemFinalLocationReached: w3, initialTopMostItemIndex: R, scrolledToInitialItem: h2 },
    f2,
    a2,
    S3,
    E,
    ...
    const { listState: z, minOverscanItemCount: O2, topItemsIndexes: V, rangeChanged: N2, ...Z } = E;
    return L(N2, C.scrollSeekRangeChanged), L(
      I(
      ...
      groupCounts: g2,
      heightEstimates: l2,
      initialItemFinalLocationReached: w3,
      initialTopMostItemIndex: R,
      scrolledToInitialItem: h2,
      sizeRanges: d2,
      topItemCount: u2,
      topItemsIndexes: V,
      // input
...
var Ie = typeof document < "u" ? import_react10.default.useLayoutEffect : import_react10.default.useEffect;
function Ye(t3, e2, n3) {
  ...
  function c2(f2, a2) {
    ...
    for (const S3 of o3) {
      const E = f2[e2.required[S3]];
      _(E, a2[S3]);
    }
    for (const S3 of r3)
      if (S3 in a2) {
        const E = f2[e2.optional[S3]];
        _(E, a2[S3]);
      }
    f2.propsReady !== void 0 && _(f2.propsReady, true);
  }
  function d2(f2) {
    return s3.reduce((a2, S3) => (a2[S3] = (E) => {
      const y2 = f2[e2.methods[S3]];
      _(y2, E);
    }, a2), {});
  }
  function m2(f2) {
    return i3.reduce((a2, S3) => (a2[S3] = Io(f2[e2.events[S3]]), a2), {});
  }
  const x2 = import_react10.default.forwardRef(function(a2, S3) {
    const { children: E, ...y2 } = a2, [k2] = import_react10.default.useState(() => ye(So(t3), (C) => {
      c2(C, y2);
    })), [u2] = import_react10.default.useState(an(m2, k2));
    Ie(() => {
      for (const C of i3)
        C in y2 && Y(u2[C], y2[C]);
      return () => {
        Object.values(u2).map(Me);
      };
    }, [y2, u2, k2]), Ie(() => {
      c2(k2, y2);
    }), import_react10.default.useImperativeHandle(S3, un(d2(k2)));
    const g2 = n3;
    return (0, import_jsx_runtime2.jsx)(l2.Provider, { value: k2, children: n3 !== void 0 ? (0, import_jsx_runtime2.jsx)(g2, { ...tr([...o3, ...r3, ...i3], y2), children: E }) : E });
  }), p2 = (f2) => {
    const a2 = import_react10.default.useContext(l2);
    ...
    const S3 = import_react10.default.useContext(l2)[f2], E = import_react10.default.useCallback(
      (y2) => Y(S3, y2),
      [S3]
    );
    ...
    const S3 = import_react10.default.useContext(l2)[f2], [E, y2] = import_react10.default.useState(an(it2, S3));
    return Ie(
      () => Y(S3, (k2) => {
        k2 !== E && y2(un(k2));
      }),
  ...
  }, R = import_react10.default.version.startsWith("18") ? T : w3;
  return {
    Component: x2,
    useEmitter: (f2, a2) => {
      const E = import_react10.default.useContext(l2)[f2];
      Ie(() => Y(E, a2), [a2, E]);
    },
    useEmitterValue: R,
    usePublisher: p2
...
var Qn = import_react10.default.createContext(void 0);
...
var Ze = Xn(() => {
  ...
  return t3.style.position = Oe, t3.style.position === Oe ? Oe : vn;
});
var to = typeof document < "u" ? import_react10.default.useLayoutEffect : import_react10.default.useEffect;
function ke(t3) {
  return "self" in t3;
}
function er(t3) {
...
function eo(t3, e2, n3, o3 = Xt, r3, s3) {
  const i3 = import_react10.default.useRef(null), l2 = import_react10.default.useRef(null), c2 = import_react10.default.useRef(null), d2 = import_react10.default.useCallback(
    (p2) => {
      let T, w3, R;
      const h2 = p2.target;
      if (er(h2) || ke(h2)) {
        const a2 = ke(h2) ? h2 : h2.defaultView;
        R = s3 === true ? a2.scrollX : a2.scrollY, T = s3 === true ? a2.document.documentElement.scrollWidth : a2.document.documentElement.scrollHeight, w3 = s3 === true ? a2.innerWidth : a2.innerHeight;
      } else
        R = s3 === true ? h2.scrollLeft : h2.scrollTop, T = s3 === true ? h2.scrollWidth : h2.scrollHeight, w3 = s3 === true ? h2.offsetWidth : h2.offsetHeight;
      const f2 = () => {
        t3({
          scrollHeight: T,
          scrollTop: Math.max(R, 0),
      ...
      p2.suppressFlushSync === true ? f2() : import_react_dom3.default.flushSync(f2), l2.current !== null && (R === l2.current || R <= 0 || R === T - w3) && (l2.current = null, e2(true), c2.current && (clearTimeout(c2.current), c2.current = null));
    },
    [t3, e2, s3]
  );
  import_react10.default.useEffect(() => {
    const p2 = r3 || i3.current;
    return o3(r3 || i3.current), d2({ suppressFlushSync: true, target: p2 }), p2.addEventListener("scroll", d2, { passive: true }), () => {
      o3(null), p2.removeEventListener("scroll", d2);
    };
  }, [i3, d2, n3, o3, r3]);
  function m2(p2) {
    const T = i3.current;
    if (!T || (s3 === true ? "offsetWidth" in T && T.offsetWidth === 0 : "offsetHeight" in T && T.offsetHeight === 0))
      return;
    const w3 = p2.behavior === "smooth";
    let R, h2, f2;
    ke(T) ? (h2 = Math.max(
      Et(T.document.documentElement, s3 === true ? "width" : "height"),
      s3 === true ? T.document.documentElement.scrollWidth : T.document.documentElement.scrollHeight
    ), R = s3 === true ? T.innerWidth : T.innerHeight, f2 = s3 === true ? window.scrollX : window.scrollY) : (h2 = T[s3 === true ? "scrollWidth" : "scrollHeight"], R = Et(T, s3 === true ? "width" : "height"), f2 = T[s3 === true ? "scrollLeft" : "scrollTop"]);
    const a2 = h2 - R;
    if (p2.top = Math.ceil(Math.max(Math.min(a2, p2.top), 0)), Un(R, h2) || p2.top === f2) {
      t3({ scrollHeight: h2, scrollTop: f2, viewportHeight: R }), w3 && e2(true);
      return;
    }
    w3 ? (l2.current = p2.top, c2.current && clearTimeout(c2.current), c2.current = setTimeout(() => {
      c2.current = null, l2.current = null, e2(true);
    }, 1e3)) : l2.current = null, s3 === true && (p2 = { ...p2.behavior !== void 0 ? { behavior: p2.behavior } : {}, left: p2.top }), T.scrollTo(p2);
  }
  function x2(p2) {
    s3 === true && (p2 = {
      ...p2.behavior !== void 0 ? { behavior: p2.behavior } : {},
      ...p2.top !== void 0 ? { left: p2.top } : {}
    }), i3.current.scrollBy(p2);
  }
  return { scrollByCallback: x2, scrollerRef: i3, scrollToCallback: m2 };
}
function Xe(t3) {
  return t3;
}
var nr = j(() => {
  const t3 = v((l2) => `Item ${l2}`), e2 = v((l2) => `Group ${l2}`), n3 = v({}), o3 = v(Xe), r3 = v("div"), s3 = v(Xt), i3 = (l2, c2 = null) => ht2(
    I(
      n3,
      B((d2) => d2[l2]),
      et()
...
var rr = ({ height: t3 }) => (0, import_jsx_runtime2.jsx)("div", { style: { height: t3 } });
...
var Cn = import_react10.default.memo(function({ showTopList: e2 = false }) {
  const n3 = A("listState"), o3 = Ct("sizeRanges"), r3 = A("useWindowScroll"), s3 = A("customScrollParent"), i3 = Ct("windowScrollContainerState"), l2 = Ct("scrollContainerState"), c2 = s3 || r3 ? i3 : l2, d2 = A("itemContent"), m2 = A("context"), x2 = A("groupContent"), p2 = A("trackItemSizes"), T = A("itemSize"), w3 = A("log"), R = Ct("gap"), h2 = A("horizontalDirection"), { callbackRef: f2 } = zn(
    o3,
    T,
    p2,
    e2 ? Xt : c2,
  ...
  ), [a2, S3] = import_react10.default.useState(0);
  tn("deviation", (F) => {
    a2 !== F && S3(F);
  });
  const E = A("EmptyPlaceholder"), y2 = A("ScrollSeekPlaceholder") ?? rr, k2 = A("ListComponent"), u2 = A("ItemComponent"), g2 = A("GroupComponent"), C = A("computeItemKey"), z = A("isSeeking"), O2 = A("groupIndices").length > 0, V = A("alignToBottom"), N2 = A("initialItemFinalLocationReached"), Z = e2 ? {} : {
    boxSizing: "border-box",
    ...h2 ? {
      display: "inline-block",
      height: "100%",
      marginLeft: a2 !== 0 ? a2 : V ? "auto" : 0,
      paddingLeft: n3.offsetTop,
      paddingRight: n3.offsetBottom,
      whiteSpace: "nowrap"
    } : {
      marginTop: a2 !== 0 ? a2 : V ? "auto" : 0,
      paddingBottom: n3.offsetBottom,
      paddingTop: n3.offsetTop
    },
    ...N2 ? {} : { visibility: "hidden" }
  };
  return !e2 && n3.totalCount === 0 && E !== null && E !== void 0 ? (0, import_jsx_runtime2.jsx)(E, { ...nt(E, m2) }) : (0, import_jsx_runtime2.jsx)(
    k2,
    {
      ...nt(k2, m2),
      ...
      children: (e2 ? n3.topItems : n3.items).map((F) => {
        const mt = F.originalIndex, q = C(mt + n3.firstItemIndex, F.data, m2);
        return z ? (0, import_react10.createElement)(
          y2,
          {
            ...nt(y2, m2),
            height: F.size,
        ...
        ) : F.type === "group" ? (0, import_react10.createElement)(
          g2,
          {
            ...nt(g2, m2),
            "data-index": mt,
          ...
          O2 ? d2(F.index, F.groupIndex, F.data, m2) : d2(F.index, F.data, m2)
        );
      })
    }
  );
...
var Jt = (t3) => ({
  ...
  top: 0,
  width: "100%",
  ...t3 ? { display: "flex", flexDirection: "column" } : void 0
});
var ur = {
  position: Ze(),
  top: 0,
...
var ar = import_react10.default.memo(function() {
  const e2 = A("HeaderComponent"), n3 = Ct("headerHeight"), o3 = A("HeaderFooterTag"), r3 = kt(
  ...
  return e2 != null ? (0, import_jsx_runtime2.jsx)(o3, { ref: r3, children: (0, import_jsx_runtime2.jsx)(e2, { ...nt(e2, s3) }) }) : null;
});
var dr = import_react10.default.memo(function() {
  const e2 = A("FooterComponent"), n3 = Ct("footerHeight"), o3 = A("HeaderFooterTag"), r3 = kt(
    import_react10.default.useMemo(
      () => (i3) => {
        n3(Et(i3, "height"));
      },
...
function Je({ useEmitter: t3, useEmitterValue: e2, usePublisher: n3 }) {
  return import_react10.default.memo(function({ children: s3, style: i3, context: l2, ...c2 }) {
    const d2 = n3("scrollContainerState"), m2 = e2("ScrollerComponent"), x2 = n3("smoothScrollTargetReached"), p2 = e2("scrollerRef"), T = e2("horizontalDirection") || false, { scrollByCallback: w3, scrollerRef: R, scrollToCallback: h2 } = eo(
      d2,
      x2,
      m2,
      p2,
    ...
    return t3("scrollTo", h2), t3("scrollBy", w3), (0, import_jsx_runtime2.jsx)(
      m2,
      {
...
function Qe({ useEmitter: t3, useEmitterValue: e2, usePublisher: n3 }) {
  return import_react10.default.memo(function({ children: s3, style: i3, context: l2, ...c2 }) {
    const d2 = n3("windowScrollContainerState"), m2 = e2("ScrollerComponent"), x2 = n3("smoothScrollTargetReached"), p2 = e2("totalListHeight"), T = e2("deviation"), w3 = e2("customScrollParent"), R = import_react10.default.useRef(null), h2 = e2("scrollerRef"), { scrollByCallback: f2, scrollerRef: a2, scrollToCallback: S3 } = eo(
      d2,
      x2,
      m2,
      h2,
    ...
    return to(() => (a2.current = w3 || R.current?.ownerDocument.defaultView, () => {
      a2.current = null;
    }), [a2, w3]), t3("windowScrollTo", S3), t3("scrollBy", f2), (0, import_jsx_runtime2.jsx)(
      m2,
      {
        ref: R,
        "data-virtuoso-scroller": true,
        style: { position: "relative", ...i3, ...p2 !== 0 ? { height: p2 + T } : void 0 },
        ...c2,
        ...nt(m2, l2),
        children: s3
      }
...
var fr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Re), n3 = Ct("viewportHeight"), o3 = Ct("fixedItemHeight"), r3 = A("alignToBottom"), s3 = A("horizontalDirection"), i3 = import_react10.default.useMemo(
    () => re(n3, (c2) => Et(c2, s3 ? "width" : "height")),
    [n3, s3]
  ), l2 = kt(i3, true, A("skipAnimationFrameInResizeObserver"));
  return import_react10.default.useEffect(() => {
    e2 && (n3(e2.viewportHeight), o3(e2.itemHeight));
  }, [e2, n3, o3]), (0, import_jsx_runtime2.jsx)("div", { "data-viewport-type": "element", ref: l2, style: Jt(r3), children: t3 });
};
var mr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Re), n3 = Ct("windowViewportRect"), o3 = Ct("fixedItemHeight"), r3 = A("customScrollParent"), s3 = Ne(
    n3,
    r3,
    A("skipAnimationFrameInResizeObserver")
  ), i3 = A("alignToBottom");
  ...
  }, [e2, n3, o3]), (0, import_jsx_runtime2.jsx)("div", { "data-viewport-type": "window", ref: s3, style: Jt(i3), children: t3 });
};
var pr = ({ children: t3 }) => {
  const e2 = A("TopItemListComponent") ?? "div", n3 = A("headerHeight"), o3 = { ...ur, marginTop: `${n3}px` }, r3 = A("context");
  return (0, import_jsx_runtime2.jsx)(e2, { style: o3, ...nt(e2, r3), children: t3 });
};
var hr = import_react10.default.memo(function(e2) {
  const n3 = A("useWindowScroll"), o3 = A("topItemsIndexes").length > 0, r3 = A("customScrollParent"), s3 = A("context");
  return (0, import_jsx_runtime2.jsxs)(r3 || n3 ? Ir : gr, { ...e2, context: s3, children: [
    o3 && (0, import_jsx_runtime2.jsx)(pr, { children: (0, import_jsx_runtime2.jsx)(Cn, { showTopList: true }) }),
    (0, import_jsx_runtime2.jsxs)(r3 || n3 ? mr : fr, { children: [
      (0, import_jsx_runtime2.jsx)(ar, {}),
      (0, import_jsx_runtime2.jsx)(Cn, {}),
...
var Yr = ro;
var xr = j(() => {
  const t3 = v((d2) => (0, import_jsx_runtime2.jsxs)("td", { children: [
    "Item $",
    d2
  ] })), e2 = v(null), n3 = v((d2) => (0, import_jsx_runtime2.jsxs)("td", { colSpan: 1e3, children: [
    "Group ",
    d2
  ] })), o3 = v(null), r3 = v(null), s3 = v({}), i3 = v(Xe), l2 = v(Xt), c2 = (d2, m2 = null) => ht2(
    I(
      s3,
      B((x2) => x2[d2]),
      et()
...
var Tr = ({ height: t3 }) => (0, import_jsx_runtime2.jsx)("tr", { children: (0, import_jsx_runtime2.jsx)("td", { style: { height: t3 } }) });
var vr = ({ height: t3 }) => (0, import_jsx_runtime2.jsx)("tr", { children: (0, import_jsx_runtime2.jsx)("td", { style: { border: 0, height: t3, padding: 0 } }) });
var Cr = { overflowAnchor: "none" };
var wn = { position: Ze(), zIndex: 2, overflowAnchor: "none" };
var yn = import_react10.default.memo(function({ showTopList: e2 = false }) {
  const n3 = M("listState"), o3 = M("computeItemKey"), r3 = M("firstItemIndex"), s3 = M("context"), i3 = M("isSeeking"), l2 = M("fixedHeaderHeight"), c2 = M("groupIndices").length > 0, d2 = M("itemContent"), m2 = M("groupContent"), x2 = M("ScrollSeekPlaceholder") ?? Tr, p2 = M("GroupComponent"), T = M("TableRowComponent"), w3 = (e2 ? n3.topItems : []).reduce((h2, f2, a2) => (a2 === 0 ? h2.push(f2.size) : h2.push(h2[a2 - 1] + f2.size), h2), []);
  return (e2 ? n3.topItems : n3.items).map((h2) => {
    const f2 = h2.originalIndex, a2 = o3(f2 + r3, h2.data, s3), S3 = e2 ? f2 === 0 ? 0 : w3[f2 - 1] : 0;
    return i3 ? (0, import_react10.createElement)(
      x2,
      {
        ...nt(x2, s3),
        height: h2.size,
    ...
    ) : h2.type === "group" ? (0, import_react10.createElement)(
      p2,
      {
        ...nt(p2, s3),
        "data-index": f2,
      ...
      T,
      {
        ...
        key: a2,
        style: e2 ? { ...wn, top: l2 + S3 } : Cr
      },
      c2 ? d2(h2.index, h2.groupIndex, h2.data, s3) : d2(h2.index, h2.data, s3)
    );
  });
});
var wr = import_react10.default.memo(function() {
  const e2 = M("listState"), n3 = M("topItemsIndexes").length > 0, o3 = bt("sizeRanges"), r3 = M("useWindowScroll"), s3 = M("customScrollParent"), i3 = bt("windowScrollContainerState"), l2 = bt("scrollContainerState"), c2 = s3 || r3 ? i3 : l2, d2 = M("trackItemSizes"), m2 = M("itemSize"), x2 = M("log"), { callbackRef: p2, ref: T } = zn(
    o3,
    m2,
    d2,
    c2,
  ...
  ), [w3, R] = import_react10.default.useState(0);
  en("deviation", (O2) => {
    w3 !== O2 && (T.current.style.marginTop = `${O2}px`, R(O2));
  });
  const h2 = M("EmptyPlaceholder"), f2 = M("FillerRow") ?? vr, a2 = M("TableBodyComponent"), S3 = M("paddingTopAddition"), E = M("statefulTotalCount"), y2 = M("context");
  if (E === 0 && h2 !== null && h2 !== void 0)
    return (0, import_jsx_runtime2.jsx)(h2, { ...nt(h2, y2) });
  const k2 = (n3 ? e2.topItems : []).reduce((O2, V) => O2 + V.size, 0), u2 = e2.offsetTop + S3 + w3 - k2, g2 = e2.offsetBottom, C = u2 > 0 ? (0, import_jsx_runtime2.jsx)(f2, { context: y2, height: u2 }, "padding-top") : null, z = g2 > 0 ? (0, import_jsx_runtime2.jsx)(f2, { context: y2, height: g2 }, "padding-bottom") : null;
  return (0, import_jsx_runtime2.jsxs)(a2, { "data-testid": "virtuoso-item-list", ref: p2, ...nt(a2, y2), children: [
    C,
    n3 && (0, import_jsx_runtime2.jsx)(yn, { showTopList: true }),
    (0, import_jsx_runtime2.jsx)(yn, {}),
    z
  ] });
});
var yr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Re), n3 = bt("viewportHeight"), o3 = bt("fixedItemHeight"), r3 = kt(
    import_react10.default.useMemo(() => re(n3, (s3) => Et(s3, "height")), [n3]),
    true,
    M("skipAnimationFrameInResizeObserver")
  );
  return import_react10.default.useEffect(() => {
    e2 && (n3(e2.viewportHeight), o3(e2.itemHeight));
  }, [e2, n3, o3]), (0, import_jsx_runtime2.jsx)("div", { "data-viewport-type": "element", ref: r3, style: Jt(false), children: t3 });
};
var br = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Re), n3 = bt("windowViewportRect"), o3 = bt("fixedItemHeight"), r3 = M("customScrollParent"), s3 = Ne(
    n3,
    r3,
    M("skipAnimationFrameInResizeObserver")
  );
  return import_react10.default.useEffect(() => {
    e2 && (o3(e2.itemHeight), n3({ offsetTop: 0, visibleHeight: e2.viewportHeight, visibleWidth: 100 }));
  }, [e2, n3, o3]), (0, import_jsx_runtime2.jsx)("div", { "data-viewport-type": "window", ref: s3, style: Jt(false), children: t3 });
};
var Rr = import_react10.default.memo(function(e2) {
  const n3 = M("useWindowScroll"), o3 = M("customScrollParent"), r3 = bt("fixedHeaderHeight"), s3 = bt("fixedFooterHeight"), i3 = M("fixedHeaderContent"), l2 = M("fixedFooterContent"), c2 = M("context"), d2 = kt(
    import_react10.default.useMemo(() => re(r3, (a2) => Et(a2, "height")), [r3]),
    true,
    M("skipAnimationFrameInResizeObserver")
  ), m2 = kt(
    import_react10.default.useMemo(() => re(s3, (a2) => Et(a2, "height")), [s3]),
    true,
    M("skipAnimationFrameInResizeObserver")
  ), x2 = o3 || n3 ? Hr : Er, p2 = o3 || n3 ? br : yr, T = M("TableComponent"), w3 = M("TableHeadComponent"), R = M("TableFooterComponent"), h2 = i3 ? (0, import_jsx_runtime2.jsx)(
    w3,
    {
      ref: d2,
    ...
    "TableHead"
  ) : null, f2 = l2 ? (0, import_jsx_runtime2.jsx)(
    R,
    {
      ref: m2,
  ...
  return (0, import_jsx_runtime2.jsx)(x2, { ...e2, ...nt(x2, c2), children: (0, import_jsx_runtime2.jsx)(p2, { children: (0, import_jsx_runtime2.jsxs)(T, { style: { borderSpacing: 0, overflowAnchor: "none" }, ...nt(T, c2), children: [
    h2,
    (0, import_jsx_runtime2.jsx)(wr, {}, "TableBody"),
    f2
  ] }) }) });
});
var {
...
function xe(t3, e2) {
  return t3 !== void 0 && t3.width === e2.width && t3.height === e2.height;
}
function kr(t3, e2) {
  return t3 !== void 0 && t3.column === e2.column && t3.row === e2.row;
}
var Lr = j(
  ([
    { increaseViewportBy: t3, listBoundary: e2, overscan: n3, visibleRange: o3 },
    { footerHeight: r3, headerHeight: s3, scrollBy: i3, scrollContainerState: l2, scrollTo: c2, scrollTop: d2, smoothScrollTargetReached: m2, viewportHeight: x2 },
    p2,
    T,
    { didMount: w3, propsReady: R },
    { customScrollParent: h2, useWindowScroll: f2, windowScrollContainerState: a2, windowScrollTo: S3, windowViewportRect: E },
    y2
  ]) => {
    const k2 = v(0), u2 = v(0), g2 = v(bn), C = v({ height: 0, width: 0 }), z = v({ height: 0, width: 0 }), O2 = U(), V = U(), N2 = v(0), Z = v(null), F = v({ column: 0, row: 0 }), mt = U(), q = U(), Q = v(false), gt = v(0), ut2 = v(true), xt = v(false), Ft = v(false);
    Y(
      I(
        w3,
        $(gt),
      ...
      I(
        at(w3, ut2, z, C, gt, xt),
        W(([b2, D, K, rt, , tt]) => b2 && !D && K.height !== 0 && rt.height !== 0 && !tt)
      ),
      ([, , , , b2]) => {
        _(xt, true), Ue(1, () => {
          _(O2, b2);
      ...
      ([, b2]) => {
        b2 && (_(C, b2.viewport), _(z, b2.item), _(F, b2.gap), b2.scrollTop > 0 && (_(Q, true), yt(I(d2, $t(1)), (D) => {
          _(Q, false);
        }), _(c2, { top: b2.scrollTop })));
      }
    ), L(
      I(
        C,
      ...
      I(
        at(
          P(C, xe),
          P(z, xe),
          P(F, (b2, D) => b2 !== void 0 && b2.column === D.column && b2.row === D.row),
          P(d2)
        ),
        B(([b2, D, K, rt]) => ({
          gap: K,
        ...
        B(
          ([
            ...
            if (St === 0 && (b2 === 0 || nn === 0))
              return bn;
            if (Ee === 0) {
              const cn = Ke(Vt, b2), uo = cn + Math.max(St - 1, 0);
              return Or(Hn(cn, uo, lt));
            }
            const ge = io(nn, Ee, Pt);
            let jt, Mt;
            ct ? D === 0 && K === 0 && St > 0 ? (jt = 0, Mt = St - 1) : (jt = ge * Ce((D + ee) / (he + ee)), Mt = ge * Rn((K + ee) / (he + ee)) - 1, Mt = Le(b2 - 1, oe(Mt, ge - 1)), jt = Le(Mt, oe(0, jt))) : (jt = 0, Mt = -1);
            const on = Hn(jt, Mt, lt), { bottom: rn, top: sn } = Bn(X, rt, tt, on), ln = Rn(b2 / ge), co = ln * he + (ln - 1) * ee - rn;
      ...
      I(
        at(C, z, g2, F),
        W(([b2, D, { items: K }]) => K.length > 0 && D.height !== 0 && b2.height !== 0),
        B(([b2, D, { items: K }, rt]) => {
          const { bottom: tt, top: X } = Bn(b2, rt, D, K);
          return [X, tt];
        }),
        et(le)
      ),
    ...
    const Kt = vt(
      I(
        at(g2, k2),
        W(([{ items: b2 }]) => b2.length > 0),
        $(pt),
        W(([[b2, D], K]) => {
          const tt = b2.items[b2.items.length - 1].index === D - 1;
          return (K || b2.bottom > 0 && b2.itemHeight > 0 && b2.offsetBottom === 0 && b2.items.length === D) && tt;
        }),
        B(([[, b2]]) => b2 - 1),
        et()
      )
      ...
      I(
        P(g2),
        W(({ items: b2 }) => b2.length > 0 && b2[0].index === 0),
        Bt(0),
        et()
      )
    ), Ht = vt(
      I(
        P(g2),
        $(Q),
        W(([{ items: b2 }, D]) => b2.length > 0 && !D),
        B(([{ items: b2 }]) => ({
          endIndex: b2[b2.length - 1].index,
          startIndex: b2[0].index
        })),
        et(An),
        zt(0)
      )
    ...
    L(Ht, T.scrollSeekRangeChanged), L(
      I(
        ...
        $(C, z, k2, F),
        B(([b2, D, K, rt, tt]) => {
          const X = $n(b2), { align: lt, behavior: St, offset: ct } = X;
          let Vt = X.index;
    ...
    const te = ht2(
      I(
        g2,
        B((b2) => b2.offsetBottom + b2.bottom)
      ),
      0
    );
    return L(
      I(
        E,
        B((b2) => ({ height: b2.visibleHeight, width: b2.visibleWidth }))
      ),
      C
    ), {
...
function io(t3, e2, n3) {
  return oe(1, Ce((t3 + n3) / (Ce(e2) + n3)));
}
function Bn(t3, e2, n3, o3) {
  const { height: r3 } = n3;
  if (r3 === void 0 || o3.length === 0)
    return { bottom: 0, top: 0 };
  const s3 = Ge(t3, e2, n3, o3[0].index);
  return { bottom: Ge(t3, e2, n3, o3[o3.length - 1].index) + r3, top: s3 };
}
function Ge(t3, e2, n3, o3) {
  const r3 = io(t3.width, n3.width, e2.column), s3 = Ce(o3 / r3), i3 = s3 * n3.height + oe(0, s3 - 1) * e2.row;
  return i3 > 0 ? i3 + e2.row : i3;
}
var zr = j(() => {
  const t3 = v((x2) => `Item ${x2}`), e2 = v({}), n3 = v(null), o3 = v("virtuoso-grid-item"), r3 = v("virtuoso-grid-list"), s3 = v(Xe), i3 = v("div"), l2 = v(Xt), c2 = (x2, p2 = null) => ht2(
    I(
      e2,
      B((T) => T[x2]),
      et()
...
var Vr = import_react10.default.memo(function() {
  const e2 = st("gridState"), n3 = st("listClassName"), o3 = st("itemClassName"), r3 = st("itemContent"), s3 = st("computeItemKey"), i3 = st("isSeeking"), l2 = wt("scrollHeight"), c2 = st("ItemComponent"), d2 = st("ListComponent"), m2 = st("ScrollSeekPlaceholder"), x2 = st("context"), p2 = wt("itemDimensions"), T = wt("gap"), w3 = st("log"), R = st("stateRestoreInProgress"), h2 = wt("reportReadyState"), f2 = kt(
    import_react10.default.useMemo(
      () => (a2) => {
        const S3 = a2.parentElement.parentElement.scrollHeight;
        l2(S3);
        const E = a2.firstChild;
        if (E !== null) {
          const { height: y2, width: k2 } = E.getBoundingClientRect();
          p2({ height: y2, width: k2 });
        }
        T({
          column: On("column-gap", getComputedStyle(a2).columnGap, w3),
          row: On("row-gap", getComputedStyle(a2).rowGap, w3)
        });
      },
      [l2, p2, T, w3]
    ),
  ...
  }, [e2]), R ? null : (0, import_jsx_runtime2.jsx)(
    d2,
    {
      className: n3,
      ref: f2,
      ...
      children: e2.items.map((a2) => {
        const S3 = s3(a2.index, a2.data, x2);
        return i3 ? (0, import_jsx_runtime2.jsx)(
          m2,
          {
            ...nt(m2, x2),
          ...
          r3(a2.index, a2.data, x2)
        );
      })
    }
  );
});
var Pr = import_react10.default.memo(function() {
  const e2 = st("HeaderComponent"), n3 = wt("headerHeight"), o3 = st("headerFooterTag"), r3 = kt(
    import_react10.default.useMemo(
      () => (i3) => {
        n3(Et(i3, "height"));
      },
...
var Wr = import_react10.default.memo(function() {
  const e2 = st("FooterComponent"), n3 = wt("footerHeight"), o3 = st("headerFooterTag"), r3 = kt(
    import_react10.default.useMemo(
      () => (i3) => {
        n3(Et(i3, "height"));
      },
...
var Gr = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Qn), n3 = wt("itemDimensions"), o3 = wt("viewportDimensions"), r3 = kt(
    import_react10.default.useMemo(
      () => (s3) => {
  ...
  }, [e2, o3, n3]), (0, import_jsx_runtime2.jsx)("div", { ref: r3, style: Jt(false), children: t3 });
};
var Ar = ({ children: t3 }) => {
  const e2 = import_react10.default.useContext(Qn), n3 = wt("windowViewportRect"), o3 = wt("itemDimensions"), r3 = st("customScrollParent"), s3 = Ne(n3, r3, false);
  return import_react10.default.useEffect(() => {
  ...
  }, [e2, n3, o3]), (0, import_jsx_runtime2.jsx)("div", { ref: s3, style: Jt(false), children: t3 });
};
var Mr = import_react10.default.memo(function({ ...e2 }) {
  const n3 = st("useWindowScroll"), o3 = st("customScrollParent"), r3 = o3 || n3 ? Dr : Nr, s3 = o3 || n3 ? Ar : Gr, i3 = st("context");
  return (0, import_jsx_runtime2.jsx)(r3, { ...e2, ...nt(r3, i3), children: (0, import_jsx_runtime2.jsxs)(s3, { children: [
    (0, import_jsx_runtime2.jsx)(Pr, {}),
    (0, import_jsx_runtime2.jsx)(Vr, {}),
    (0, import_jsx_runtime2.jsx)(Wr, {})
  ] }) });
});
var {
  Component: _r,
...
function cloneObject(data) {
  ...
  if (!isArray3 && !(isObject(data) && isPlainObject3(data))) {
    return data;
  }
  const copy3 = isArray3 ? [] : Object.create(Object.getPrototypeOf(data));
...
var HookFormControlContext = import_react11.default.createContext(null);
HookFormControlContext.displayName = "HookFormControlContext";
var useFormControlContext = () => import_react11.default.useContext(HookFormControlContext);
...
function useWatch(props) {
  ...
  const _defaultValue = import_react11.default.useRef(defaultValue);
  const _compute = import_react11.default.useRef(compute);
  const _computeFormValues = import_react11.default.useRef(void 0);
  const _prevControl = import_react11.default.useRef(control);
  const _prevName = import_react11.default.useRef(name);
  _compute.current = compute;
  const [value, updateValue] = import_react11.default.useState(() => {
  ...
  const getCurrentOutput = import_react11.default.useCallback((values) => {
    const formValues = generateWatchOutput(name, control._names, values || control._formValues, false, _defaultValue.current);
    return _compute.current ? _compute.current(formValues) : formValues;
  }, [control._formValues, control._names, name]);
  const refreshValue = import_react11.default.useCallback((values) => {
    if (!disabled) {
      const formValues = generateWatchOutput(name, control._names, values || control._formValues, false, _defaultValue.current);
      if (_compute.current) {
  ...
  const computedOutput = import_react11.default.useMemo(() => {
    if (disabled) {
      return null;
    }
...
function useController(props) {
  ...
  const defaultValueMemo = import_react11.default.useMemo(() => get2(control._formValues, name, get2(control._defaultValues, name, defaultValue)), [control, name, defaultValue]);
  ...
  const _previousNameRef = import_react11.default.useRef(void 0);
  ...
  const ref = import_react11.default.useCallback((elm) => {
    ...
    if (field2 && field2._f && elm) {
      field2._f.ref = {
        focus: () => isFunction2(elm.focus) && elm.focus(),
        select: () => isFunction2(elm.select) && elm.select(),
        setCustomValidity: (message) => isFunction2(elm.setCustomValidity) && elm.setCustomValidity(message),
        reportValidity: () => isFunction2(elm.reportValidity) && elm.reportValidity()
      };
    }
  ...
  import_react11.default.useEffect(() => {
    ...
    control.register(name, {
      ...
      ...isBoolean3(_props.current.disabled) ? { disabled: _props.current.disabled } : {}
    });
    ...
    if (_shouldUnregisterField) {
      const value2 = cloneObject(get2(control._options.defaultValues, name, _props.current.defaultValue));
...
function schemaErrorLookup(errors2, _fields, name) {
  ...
  while (names.length) {
    ...
    const foundError = get2(errors2, fieldName);
...
var updateFieldArrayRootError = (errors2, error, name) => {
  const fieldArrayErrors = convertToArrayPayload(get2(errors2, name));
  set2(fieldArrayErrors, ROOT_ERROR_TYPE, error[name]);
  set2(errors2, name, fieldArrayErrors);
  return errors2;
};
function getValidateError(result, ref, type = "validate") {
  if (isString(result) || Array.isArray(result) && result.every(isString) || isBoolean3(result) && !result) {
    return {
      type,
...
var validateField = async (field, disabledFieldNames, formValues, validateAllFieldCriteria, shouldUseNativeValidation, isFieldArray) => {
  ...
  const setCustomValidity = (message) => {
    if (shouldUseNativeValidation && inputRef.reportValidity) {
      inputRef.setCustomValidity(isBoolean3(message) ? "" : message || "");
  ...
  if (isFieldArray ? !Array.isArray(inputValue) || !inputValue.length : required && (!isRadioOrCheckbox2 && (isEmpty || isNullOrUndefined(inputValue)) || isBoolean3(inputValue) && !inputValue || isCheckBox && !getCheckboxValue(refs).isValid || isRadio && !getRadioValue(refs).isValid)) {
...
function createFormControl(props = {}) {
  ...
  const _setValid = async (shouldUpdateValid) => {
    ...
    if (!_options.disabled && (_proxyFormState.isValid || _proxySubscribeFormState.isValid || shouldUpdateValid)) {
      ...
      if (_options.resolver) {
        isValid3 = isEmptyObject((await _runSchema()).errors);
        _updateIsValidating();
      } else {
        isValid3 = await executeBuiltInValidation({
          fields: _fields,
          onlyCheckValid: true,
  ...
  const _setFieldArray = (name, values = [], method, args, shouldSetValues = true, shouldUpdateFieldsAndState = true) => {
    if (args && method && !_options.disabled) {
      ...
      if (shouldUpdateFieldsAndState && Array.isArray(get2(_formState.errors, name))) {
        const errors2 = method(get2(_formState.errors, name), args.argA, args.argB);
      ...
      if (_proxyFormState.dirtyFields || _proxySubscribeFormState.dirtyFields) {
        ...
        set2(_formState.dirtyFields, rootName, get2(fullDirtyFields, rootName));
      }
      _subjects.state.next({
        name,
  ...
  const shouldRenderByError = (name, isValid3, error, fieldState) => {
    ...
    const shouldUpdateValid = (_proxyFormState.isValid || _proxySubscribeFormState.isValid) && isBoolean3(isValid3) && _formState.isValid !== isValid3;
  ...
  const executeSchemaAndUpdateState = async (names) => {
    const { errors: errors2 } = await _runSchema(names);
    ...
    for (const name2 in fields) {
      ...
      if (field) {
        ...
        if (_f) {
          ...
          !onlyCheckValid && (get2(fieldError, _f.name) ? isFieldArrayRoot ? updateFieldArrayRootError(_formState.errors, fieldError, _f.name) : set2(_formState.errors, _f.name, fieldError[_f.name]) : unset(_formState.errors, _f.name));
  ...
  const onChange2 = async (event) => {
    ...
    if (field) {
      ...
      const shouldSkipValidation = !hasValidation(field._f) && !props.validate && !_options.resolver && !get2(_formState.errors, name) && !field._f.deps || skipValidation(isBlurEvent, get2(_formState.touchedFields, name), _formState.isSubmitted, validationModeAfterSubmit, validationModeBeforeSubmit);
      ...
      if (_options.resolver) {
        ...
        if (isFieldValueUpdated) {
          ...
          isValid3 = isEmptyObject(errors2);
        }
      } else {
        _updateIsValidating([name], true);
  ...
  const trigger = async (name, options2 = {}) => {
    ...
    if (_options.resolver) {
      ...
      isValid3 = isEmptyObject(errors2);
      validationResult = name ? !fieldNames.some((name2) => get2(errors2, name2)) : isValid3;
    } else if (name) {
      ...
      validationResult = isValid3 = await executeBuiltInValidation({
        fields: _fields,
        name,
        eventType: EVENTS.TRIGGER
      });
  ...
  const register = (name, options2 = {}) => {
    ...
    const disabledIsDefined = isBoolean3(options2.disabled) || isBoolean3(_options.disabled);
    set2(_fields, name, {
      ...field || {},
      _f: {
    ...
    if (field) {
      _setDisabledField({
        disabled: isBoolean3(options2.disabled) ? options2.disabled : _options.disabled,
        name
      });
    } else {
    ...
    if (!keepStateOptions.keepValues) {
      if (keepStateOptions.keepDirtyValues) {
        ...
        for (const fieldName of Array.from(fieldsToCheck)) {
          const isDirty2 = get2(_formState.dirtyFields, fieldName);
          const existingValue = get2(_formValues, fieldName);
          const newValue = get2(values, fieldName);
          if (isDirty2 && !isUndefined(existingValue)) {
            set2(values, fieldName, existingValue);
  ...
  const reset = (formValues, keepStateOptions) => _reset(isFunction2(formValues) ? formValues(_formValues) : formValues, { ..._options.resetOptions, ...keepStateOptions });
  const setFocus = (name, options2 = {}) => {
    ...
    if (fieldReference) {
      ...
      if (fieldRef.focus) {
        setTimeout(() => {
          fieldRef.focus();
          options2.shouldSelect && isFunction2(fieldRef.select) && fieldRef.select();
        });
      }
    }
  };
...
function useForm(props = {}) {
  ...
  _formControl.current.formState = import_react11.default.useMemo(() => getProxyFormState(formState, control), [control, formState]);
...
var r = (s3, r3) => {
  ...
  const f2 = {};
  for (const o3 in s3) {
    const n3 = get2(r3.fields, o3), a2 = Object.assign(s3[o3] || {}, { ref: n3 && n3.ref });
    if (i(r3.names || Object.keys(s3), o3)) {
      const s4 = Object.assign({}, get2(f2, o3));
      set2(s4, "root", a2), set2(f2, o3, s4);
    } else set2(f2, o3, a2);
  }
  return f2;
};
...
// ../node_modules/.pnpm/filesize@9.0.11/node_modules/filesize/lib/filesize.esm.js
var ARRAY = "array";
var BIT = "bit";
var BITS = "bits";
var BYTE = "byte";
...
function filesize(arg, {
  ...
  if (pad && Number.isInteger(result[0]) === false && round > 0) {
    const x2 = separator || PERIOD, tmp = result[0].toString().split(x2), s3 = tmp[1] || EMPTY2, l2 = s3.length, n3 = round - l2;
    result[0] = `${tmp[0]}${x2}${s3.padEnd(l2 + n3, ZERO)}`;
  }
  if (full) {
...
// ../node_modules/.pnpm/react-file-icon@1.6.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-file-icon/dist/react-file-icon.esm.js
...
// ../node_modules/.pnpm/react-select@5.10.2_@types+react@19.2.14_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-select/creatable/dist/react-select-creatable.esm.js
var React8 = __toESM(require_react());
var import_react14 = __toESM(require_react());

// ../node_modules/.pnpm/react-select@5.10.2_@types+react@19.2.14_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-select/dist/useCreatable-09aaeb9a.esm.js
...
var CreatableSelect = (0, import_react14.forwardRef)(function(props, ref) {
  ...
  return React8.createElement(Select, _extends({
    ref
  }, selectProps));
});
var CreatableSelect$1 = CreatableSelect;

// ../node_modules/.pnpm/react-dropzone@11.7.1_react@19.2.4/node_modules/react-dropzone/dist/es/index.js
var import_react16 = __toESM(require_react());
var import_prop_types2 = __toESM(require_prop_types());

// ../node_modules/.pnpm/file-selector@0.4.0/node_modules/file-selector/dist/es5/file.js
...
// ../node_modules/.pnpm/file-selector@0.4.0/node_modules/file-selector/dist/es5/file-selector.js
var FILES_TO_IGNORE = [
...
// ../node_modules/.pnpm/react-dropzone@11.7.1_react@19.2.4/node_modules/react-dropzone/dist/es/utils/index.js
  ...
  var setFiles = (0, import_react16.useCallback)(function(files, event) {
    ...
    files.forEach(function(file) {
      ...
      if (accepted && sizeMatch && !customErrors) {
        ...
        fileRejections.push({
          file,
          errors: errors2.filter(function(e2) {
            return e2;
          })
        });
      }
...
var AssetBrowserDispatchProvider = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(AssetSourceDispatchContext.Provider, { value: contextValue, children });
};
...
var debugThrottle = (throttled) => function(source) {
  return iif(
    ...
    source.pipe(
      delay(3e3),
      mergeMap((v3) => Math.random() > 0.5 ? throwError({
        message: "Test error",
        statusCode: 500
      }) : of(v3))
    ),
...
var selectTagSelectOptions = (asset) => (state) => {
  const tags = asset?.opt?.media?.tags?.reduce((acc, v3) => {
    const tagItem = state.tags.byIds[v3._ref];
...
var ButtonViewGroup = () => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Inline, { space: 0, style: { whiteSpace: "nowrap" }, children: [
...
var OrderSelect = () => {
  ...
  return (0, import_jsx_runtime3.jsx)(
    MenuButton,
    {
      button: (0, import_jsx_runtime3.jsx)(
        Button,
        {
          fontSize: 1,
          icon: SortIcon,
      ...
      id: "order",
      menu: (0, import_jsx_runtime3.jsx)(Menu, { children: ORDER_OPTIONS?.map((item, index2) => {
        if (item) {
        ...
        return (0, import_jsx_runtime3.jsx)(MenuDivider, {}, index2);
      }) }),
...
var Container$1 = ut(Box)(({ $scheme, theme }) => it`
...
var SearchFacet = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Container$1, { padding: [2, 2, 1], $scheme: scheme, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: ["flex-start", "flex-start", "center"], direction: ["column", "column", "row"], children: [
    (0, import_jsx_runtime3.jsx)(Box, { paddingBottom: [3, 3, 0], paddingLeft: 1, paddingRight: 2, paddingTop: [1, 1, 0], children: (0, import_jsx_runtime3.jsx)(
      Label,
      {
        size: 0,
        style: {
    ...
    (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", children: [
      children,
      (0, import_jsx_runtime3.jsx)(Box, { marginLeft: 1, paddingX: 2, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 0, children: (0, import_jsx_runtime3.jsx)(CloseIcon, { onClick: handleClose }) }) })
    ] })
  ] }) });
};
...
var SearchFacetNumber = ({ facet }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(SearchFacet, { facet, children: [
    facet?.operatorTypes && (0, import_jsx_runtime3.jsx)(
      MenuButton,
      {
        button: (0, import_jsx_runtime3.jsx)(
          Button,
        ...
        id: "operators",
        menu: (0, import_jsx_runtime3.jsx)(Menu, { children: facet.operatorTypes.map((operatorType, index2) => operatorType ? (0, import_jsx_runtime3.jsx)(
          MenuItem,
          {
          ...
          operatorType
        ) : (0, import_jsx_runtime3.jsx)(MenuDivider, {}, index2)) }),
        popover: popoverProps
      }
    ),
    (0, import_jsx_runtime3.jsx)(Box, { marginX: 1, style: { maxWidth: "50px" }, children: (0, import_jsx_runtime3.jsx)(
      TextInputNumber,
      {
        fontSize: 1,
    ...
    modifiers && (0, import_jsx_runtime3.jsx)(
      MenuButton,
      {
        button: (0, import_jsx_runtime3.jsx)(
          Button,
        ...
        id: "modifier",
        menu: (0, import_jsx_runtime3.jsx)(Menu, { children: modifiers.map((modifier) => {
...
var SearchFacetSelect = ({ facet }) => {
  const dispatch = useDispatch(), popoverProps = usePortalPopoverProps(), options2 = facet?.options, selectedItem = options2?.find((v3) => v3.name === facet?.value), handleListItemClick = (option) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(SearchFacet, { facet, children: [
    facet?.operatorTypes && (0, import_jsx_runtime3.jsx)(
      MenuButton,
      {
        button: (0, import_jsx_runtime3.jsx)(Box, { marginRight: 1, children: (0, import_jsx_runtime3.jsx)(
          Button,
          {
            fontSize: 1,
            iconRight: SelectIcon,
    ...
    (0, import_jsx_runtime3.jsx)(
      MenuButton,
      {
        button: (0, import_jsx_runtime3.jsx)(Button, { fontSize: 1, iconRight: SelectIcon, padding: 2, text: selectedItem?.title }),
        id: "list",
        menu: (0, import_jsx_runtime3.jsx)(Menu, { children: options2?.map((item, index2) => {
...
var SearchFacetString = ({ facet }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(SearchFacet, { facet, children: [
    ...
    !operators[selectedOperatorType].hideInput && (0, import_jsx_runtime3.jsx)(Box, { marginLeft: 1, style: { maxWidth: "125px" }, children: (0, import_jsx_runtime3.jsx)(
      TextInput,
      {
        fontSize: 1,
...
var ClearIndicator3 = (props) => (0, import_jsx_runtime3.jsx)(components.ClearIndicator, { ...props, children: (0, import_jsx_runtime3.jsx)(
  Box,
  {
    paddingRight: 1,
    style: {
    ...
    children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 0, children: (0, import_jsx_runtime3.jsx)(CloseIcon, {}) })
  }
) });
var Menu$12 = (props) => (0, import_jsx_runtime3.jsx)(components.Menu, { ...props, children: (0, import_jsx_runtime3.jsx)(Card, { radius: 1, shadow: 2, children: props.children }) });
var MenuList$1 = (props) => {
    ...
    return (0, import_jsx_runtime3.jsx)(
      qr,
      {
        ...
        itemContent: (index2) => {
          ...
          return (0, import_jsx_runtime3.jsx)(Option$12, { ...item.props });
        },
        style: { height },
  ...
  return (0, import_jsx_runtime3.jsx)(components.MenuList, { ...props, children });
};
var NoOptionsMessage3 = (props) => (0, import_jsx_runtime3.jsx)(components.NoOptionsMessage, { ...props, children: props.children });
var Option$12 = (props) => (0, import_jsx_runtime3.jsx)(Box, { padding: 1, children: (0, import_jsx_runtime3.jsx)(components.Option, { ...props, children: (0, import_jsx_runtime3.jsx)(Box, { paddingY: 1, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, style: { color: "inherit" }, textOverflow: "ellipsis", children: props.children }) }) }) });
var SingleValue3 = (props) => (0, import_jsx_runtime3.jsx)(components.SingleValue, { ...props, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, textOverflow: "ellipsis", children: props.children }) });
...
var SearchFacetTags = ({ facet }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(SearchFacet, { facet, children: [
    ...
    !operators[selectedOperatorType].hideInput && (0, import_jsx_runtime3.jsx)(Box, { marginX: 1, style: { width: "160px" }, children: (0, import_jsx_runtime3.jsx)(
...
var StackContainer = ut(Flex)(({ theme }) => it`
    > * {
...
var SearchFacets = (props) => {
  const { layout = "inline" } = props, searchFacets = useTypedSelector((state) => state.search.facets), Items2 = searchFacets.map((facet) => {
    const key = facet.id;
    return facet.type === "number" ? (0, import_jsx_runtime3.jsx)(SearchFacetNumber, { facet }, key) : facet.type === "searchable" ? (0, import_jsx_runtime3.jsx)(SearchFacetTags, { facet }, key) : facet.type === "select" ? (0, import_jsx_runtime3.jsx)(SearchFacetSelect, { facet }, key) : facet.type === "string" ? (0, import_jsx_runtime3.jsx)(SearchFacetString, { facet }, key) : null;
  });
  if (layout === "inline")
    return searchFacets.length === 0 ? null : (0, import_jsx_runtime3.jsx)(Box, { marginBottom: 2, children: (0, import_jsx_runtime3.jsx)(Inline, { space: 2, children: Items2 }) });
  if (layout === "stack")
    return (0, import_jsx_runtime3.jsx)(StackContainer, { align: "flex-start", direction: "column", children: Items2 });
...
var ToolOptionsProvider = ({ options: options2, children }) => {
  const value = (0, import_react17.useMemo)(() => {
    ...
    return options2?.creditLine?.excludeSources && (creditLineExcludeSources = Array.isArray(options2?.creditLine?.excludeSources) ? options2.creditLine.excludeSources : [options2?.creditLine?.excludeSources]), {
      ...
      components: {
        details: options2?.components?.details
      },
      creditLine: {
        enabled: options2?.creditLine?.enabled || false,
        excludeSources: creditLineExcludeSources
      },
      directUploads: options2?.directUploads ?? true
    };
  }, [
    ...
    options2?.directUploads
  ]);
  return (0, import_jsx_runtime3.jsx)(ToolOptionsContext.Provider, { value, children });
};
var useToolOptions = () => {
...
var SearchFacetsControl = () => {
  ...
  }), hasSearchFacets = filteredFacets.length > 0, renderMenuFacets = (facets, level = 0) => (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: facets?.map((facet, index2) => {
    if (facet.type === "divider")
      return (0, import_jsx_runtime3.jsx)(MenuDivider, {}, index2);
    if (facet.type === "group")
      return (0, import_jsx_runtime3.jsx)(MenuGroup, { text: facet.title, title: facet.title, children: renderMenuFacets(facet.facets, level + 1) }, `group-${level}-${index2}`);
    if (facet) {
      const disabled = !facet.operatorTypes && !!searchFacets.find((v3) => v3.name === facet.name);
      return (0, import_jsx_runtime3.jsx)(
        MenuItem,
        {
          disabled,
  ...
  return (0, import_jsx_runtime3.jsxs)(Flex, { children: [
    (0, import_jsx_runtime3.jsx)(
      MenuButton,
      {
        ...
        id: "facets",
        menu: (0, import_jsx_runtime3.jsx)(Menu, { children: renderMenuFacets(filteredFacets) }),
        popover: {
          ...popoverProps,
    ...
    searchFacets.length > 0 && (0, import_jsx_runtime3.jsx)(
      Button,
      {
        fontSize: 1,
        mode: "bleed",
...
var TagIcon = () => (0, import_jsx_runtime3.jsxs)(
  "svg",
  {
    ...
    children: [
      ...
      (0, import_jsx_runtime3.jsx)("path", { d: "M384 160a32 32 0 1132-32 32 32 0 01-32 32z" })
    ]
  }
);
var TextInputSearch = () => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Box, { style: { position: "relative" }, children: [
    (0, import_jsx_runtime3.jsx)(
      TextInput,
      {
        fontSize: 1,
    ...
    searchQuery.length > 0 && (0, import_jsx_runtime3.jsx)(
      Flex,
      {
        align: "center",
        justify: "center",
...
var Controls = () => {
  ...
  return (0, import_jsx_runtime3.jsxs)(
    Box,
    {
      ...
      children: [
        (0, import_jsx_runtime3.jsx)(Box, { marginBottom: 2, children: (0, import_jsx_runtime3.jsx)(
          Flex,
          {
            align: "flex-start",
            ...
            children: (0, import_jsx_runtime3.jsxs)(
              Flex,
              {
                ...
                children: [
                  (0, import_jsx_runtime3.jsx)(Box, { marginX: 2, style: { minWidth: "200px" }, children: (0, import_jsx_runtime3.jsx)(TextInputSearch, {}) }),
                  (0, import_jsx_runtime3.jsxs)(Box, { display: ["none", "none", "block"], children: [
                    (0, import_jsx_runtime3.jsx)(SearchFacets, {}),
                    (0, import_jsx_runtime3.jsx)(SearchFacetsControl, {})
                  ] }),
                  (0, import_jsx_runtime3.jsx)(Box, { display: ["block", "block", "none"], marginX: 2, children: (0, import_jsx_runtime3.jsxs)(Inline, { space: 2, style: { whiteSpace: "nowrap" }, children: [
                    (0, import_jsx_runtime3.jsx)(
                      Button,
                      {
                        fontSize: 1,
        ...
        (0, import_jsx_runtime3.jsx)(Box, { children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", justify: ["space-between"], children: [
          (0, import_jsx_runtime3.jsx)(Box, { marginX: 2, children: (0, import_jsx_runtime3.jsx)(ButtonViewGroup, {}) }),
          (0, import_jsx_runtime3.jsxs)(Flex, { marginX: 2, children: [
            (0, import_jsx_runtime3.jsx)(OrderSelect, {}),
            (0, import_jsx_runtime3.jsx)(Box, { display: ["none", "none", "block"], marginLeft: 2, children: (0, import_jsx_runtime3.jsx)(
              Button,
              {
                fontSize: 1,
                icon: (0, import_jsx_runtime3.jsx)(Box, { style: { transform: "scale(0.75)" }, children: (0, import_jsx_runtime3.jsx)(TagIcon, {}) }),
        ...
        (0, import_jsx_runtime3.jsx)(Progress, { loading: fetching }, pageIndex)
      ]
    }
  );
};
...
var DebugControls = () => {
  ...
  }), debugEnabled ? (0, import_jsx_runtime3.jsx)(
    Box,
    {
      padding: 4,
      style: {
      ...
      children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", children: [
        (0, import_jsx_runtime3.jsx)(Box, { marginRight: 3, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime3.jsx)(PlugIcon, {}) }) }),
        (0, import_jsx_runtime3.jsx)(
          Tooltip,
          {
            animate: true,
            content: (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: badConnection ? "Bad connection: +3000ms & 50% chance to fail" : "No connection throttling" }) }),
...
var ButtonAssetCopy = ({ disabled, url }) => {
  ...
  return (0, import_react17.useEffect)(() => () => {
    ...
    Popover,
    {
      content: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: "Copied!" }),
      open: popoverVisible,
      padding: 2,
      placement: "top",
      radius: 1,
...
var Row = ({ label, value }) => (0, import_jsx_runtime3.jsxs)(Flex, { justify: "space-between", children: [
  (0, import_jsx_runtime3.jsx)(
    Text,
    {
      size: 1,
...
var AssetMetadata = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Box, { marginTop: 3, children: [
    (0, import_jsx_runtime3.jsx)(Box, { children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
      (0, import_jsx_runtime3.jsx)(Row, { label: "Size", value: filesize(asset?.size, { base: 10, round: 0 }) }),
      (0, import_jsx_runtime3.jsx)(Row, { label: "MIME type", value: asset?.mimeType }),
      (0, import_jsx_runtime3.jsx)(Row, { label: "Extension", value: (asset?.extension).toUpperCase() }),
      isImageAsset(asset) && (0, import_jsx_runtime3.jsx)(Row, { label: "Dimensions", value: getAssetResolution(asset) })
    ] }) }),
    exif && (exif.DateTimeOriginal || exif.FNumber || exif.FocalLength || exif.ExposureTime || exif.ISO) && (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
      (0, import_jsx_runtime3.jsx)(
        Box,
        {
          marginY: 4,
      ...
      (0, import_jsx_runtime3.jsx)(Box, { children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
        exif.ISO && (0, import_jsx_runtime3.jsx)(Row, { label: "ISO", value: exif.ISO }),
        exif.FNumber && (0, import_jsx_runtime3.jsx)(Row, { label: "Aperture", value: `ƒ/${exif.FNumber}` }),
        exif.FocalLength && (0, import_jsx_runtime3.jsx)(Row, { label: "Focal length", value: `${exif.FocalLength}mm` }),
        exif.ExposureTime && (0, import_jsx_runtime3.jsx)(Row, { label: "Exposure time", value: `1/${1 / exif.ExposureTime}` }),
        exif.DateTimeOriginal && (0, import_jsx_runtime3.jsx)(
          Row,
          {
            label: "Original date",
    ...
    (0, import_jsx_runtime3.jsx)(Box, { marginTop: 5, children: (0, import_jsx_runtime3.jsxs)(Inline, { space: 2, children: [
      (0, import_jsx_runtime3.jsx)(
        Button,
        {
      ...
      (0, import_jsx_runtime3.jsx)(ButtonAssetCopy, { disabled: !item || item?.updating, url: asset.url })
    ] }) })
  ] });
};
var Dialog2 = (props) => (0, import_jsx_runtime3.jsx)(Dialog, { ...props, style: { position: "fixed" } });
var DocumentList = ({ documents, isLoading }) => {
  const schema = useSchema();
  return isLoading ? (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: "Loading..." }) : documents.length === 0 ? (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: "No documents are referencing this asset" }) : (0, import_jsx_runtime3.jsx)(Card, { flex: 1, marginBottom: 2, padding: 2, radius: 2, shadow: 1, children: (0, import_jsx_runtime3.jsx)(Stack, { space: 2, children: documents?.map((doc) => (0, import_jsx_runtime3.jsx)(ReferringDocument, { doc, schemaType: schema.get(doc._type) }, doc._id)) }) });
};
var ReferringDocument = (props) => {
  ...
  return schemaType ? (0, import_jsx_runtime3.jsx)(Button, { mode: "bleed", onClick, padding: 2, style: { width: "100%" }, children: (0, import_jsx_runtime3.jsx)(Preview$1, { layout: "default", schemaType, value: doc }) }, doc._id) : (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsxs)(Text, { size: 1, children: [
    "A document of the unknown type ",
    (0, import_jsx_runtime3.jsx)("em", { children: doc._type })
  ] }) });
};
var Container2 = ut(Box)(({ theme }) => it`
    text {
...
var FileIcon3 = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Flex, { align: "center", justify: "center", onClick, style: { height: "100%" }, children: (0, import_jsx_runtime3.jsx)(Container2, { style: { width }, children: extension ? (0, import_jsx_runtime3.jsx)(
    FileIcon,
    {
      extension,
      ...defaultStyles2[extension]
    }
  ) : (0, import_jsx_runtime3.jsx)(FileIcon, {}) }) });
};
var FileAssetPreview = (props) => {
  const { asset } = props;
  return asset.mimeType.search("audio") === 0 ? (0, import_jsx_runtime3.jsx)(Flex, { align: "center", justify: "center", style: { height: "100%" }, children: (0, import_jsx_runtime3.jsx)("audio", { controls: true, src: asset.url, style: { width: "100%" } }) }) : asset.mimeType.search("video") === 0 ? (0, import_jsx_runtime3.jsx)(
    "video",
    {
      controls: true,
      src: asset.url,
  ...
  ) : (0, import_jsx_runtime3.jsx)(FileIcon3, { extension: asset.extension, width: "50%" });
};
var FormSubmitButton = (props) => {
  const { disabled, isValid: isValid3, lastUpdated, onClick } = props;
  let content;
  return isValid3 ? lastUpdated ? content = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    "Last updated",
    (0, import_jsx_runtime3.jsx)("br", {}),
    " ",
    format(new Date(lastUpdated), "PPp")
  ] }) : content = "No unpublished changes" : content = "There are validation errors that need to be fixed before this document can be published", (0, import_jsx_runtime3.jsx)(
    Tooltip,
    {
      animate: true,
      content: (0, import_jsx_runtime3.jsx)(Box, { padding: 3, style: { maxWidth: "185px" }, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: content }) }),
      disabled: "ontouchstart" in window,
      placement: "top",
      portal: true,
      children: (0, import_jsx_runtime3.jsx)(Box, { children: (0, import_jsx_runtime3.jsx)(
        Button,
        {
          disabled,
          fontSize: 1,
...
var Image$1 = ut.img`
  ...
  ${(props) => props.$showCheckerboard && it`
...
var DropdownIndicator3 = (props) => (0, import_jsx_runtime3.jsx)(components.DropdownIndicator, { ...props, children: (0, import_jsx_runtime3.jsx)(Box, { paddingX: 2, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(ChevronDownIcon, {}) }) }) });
var Menu4 = (props) => (0, import_jsx_runtime3.jsx)(components.Menu, { ...props, children: (0, import_jsx_runtime3.jsx)(Card, { radius: 1, shadow: 2, children: props.children }) });
var MenuList3 = (props) => {
  ...
  if (Array.isArray(children)) {
    ...
    return (0, import_jsx_runtime3.jsx)(
      qr,
      {
        ...
        itemContent: (index2) => {
          const item = children[index2];
          return (0, import_jsx_runtime3.jsx)(Option3, { ...item.props });
        },
        style: { height },
        totalCount: children.length
      }
...
var MultiValueLabel2 = (props) => (0, import_jsx_runtime3.jsx)(Box, { padding: 2, paddingRight: 1, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "medium", children: (0, import_jsx_runtime3.jsx)(components.MultiValueLabel, { ...props }) }) });
var MultiValueRemove2 = (props) => (0, import_jsx_runtime3.jsx)(components.MultiValueRemove, { ...props, children: (0, import_jsx_runtime3.jsx)(CloseIcon, { color: "#1f2123" }) });
var Option3 = (props) => (0, import_jsx_runtime3.jsx)(Box, { paddingX: 1, paddingY: 1, children: (0, import_jsx_runtime3.jsx)(components.Option, { ...props, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", children: [
  props.data.__isNew__ && (0, import_jsx_runtime3.jsx)(AddIcon, { style: { marginRight: "3px" } }),
  props.children
] }) }) });
...
var StyledErrorOutlineIcon = ut(ErrorOutlineIcon)(({ theme }) => ({
...
var FormFieldInputLabel = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    (0, import_jsx_runtime3.jsx)(Box, { marginY: 3, children: (0, import_jsx_runtime3.jsxs)(Inline, { space: 2, children: [
      (0, import_jsx_runtime3.jsx)(Text, { as: "label", htmlFor: name, size: 1, weight: "semibold", children: label }),
      error && (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(
        Tooltip,
        {
          animate: true,
          content: (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsxs)(Text, { muted: true, size: 1, children: [
            (0, import_jsx_runtime3.jsx)(StyledErrorOutlineIcon, { style: { marginRight: "0.1em" } }),
            error
          ] }) }),
          fallbackPlacements: ["top", "left"],
          placement: "right",
          portal: true,
          children: (0, import_jsx_runtime3.jsx)(StyledErrorOutlineIcon, {})
        }
      ) })
    ] }) }),
    description && (0, import_jsx_runtime3.jsx)(Box, { marginY: 3, children: (0, import_jsx_runtime3.jsx)(Text, { htmlFor: name, muted: true, size: 1, children: description }) })
  ] });
};
var FormFieldInputTags = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(
    Box,
    {
      style: { zIndex: 2 },
      children: [
        (0, import_jsx_runtime3.jsx)(FormFieldInputLabel, { description, error, label, name }),
        (0, import_jsx_runtime3.jsx)(
          Controller,
          {
            control,
  ...
  return (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
    (0, import_jsx_runtime3.jsx)(
      FormFieldInputTags,
      {
        ...
        error: errors2?.opt?.media?.tags?.message,
        label: "Tags",
        name: "opt.media.tags",
    ...
    (0, import_jsx_runtime3.jsx)(
      FormFieldInputText,
      {
        ...
        disabled: formUpdating,
        error: errors2?.originalFilename?.message,
        label: "Filename",
    ...
    creditLine?.enabled && (0, import_jsx_runtime3.jsx)(
      FormFieldInputText,
      {
        ...register("creditLine"),
        error: errors2?.creditLine?.message,
        label: "Credit",
        name: "creditLine",
...
function renderDefaultDetails(props) {
  return (0, import_jsx_runtime3.jsx)(Details, { ...props });
}
var DialogAssetEdit = (props) => {
  const {
    children,
    dialog: { assetId, id, lastCreatedTag, lastRemovedTagIds }
  } = props, client = useVersionedClient(), scheme = useColorSchemeValue(), documentStore = useDocumentStore(), dispatch = useDispatch(), assetItem = useTypedSelector((state) => selectAssetById(state, String(assetId))), tags = useTypedSelector(selectTags), assetUpdatedPrev = (0, import_react17.useRef)(void 0), [assetSnapshot, setAssetSnapshot] = (0, import_react17.useState)(assetItem?.asset), [tabSection, setTabSection] = (0, import_react17.useState)("details"), currentAsset = assetItem ? assetItem?.asset : assetSnapshot, allTagOptions = getTagSelectOptions(tags), assetTagOptions = useTypedSelector(selectTagSelectOptions(currentAsset)), { creditLine, components: { details: CustomDetails } = {} } = useToolOptions(), generateDefaultValues = (0, import_react17.useCallback)(
    (asset) => ({
    ...
    formState: { errors: errors2, isDirty: isDirty2, isValid: isValid3 },
    getValues,
    handleSubmit,
    register,
    reset,
  ...
  }), formUpdating = !assetItem || assetItem?.updating, handleClose = (0, import_react17.useCallback)(() => {
  ...
  }, [assetItem?.asset, client, handleAssetUpdate]), (0, import_react17.useEffect)(() => {
    if (lastCreatedTag) {
  ...
  const Footer = () => (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsxs)(Flex, { justify: "space-between", children: [
    (0, import_jsx_runtime3.jsx)(
      Button,
      {
        disabled: formUpdating,
  ...
  return (0, import_jsx_runtime3.jsxs)(
    ...
    {
      animate: true,
      footer: (0, import_jsx_runtime3.jsx)(Footer, {}),
      header: "Asset details",
      id,
      onClose: handleClose,
      width: 3,
      children: [
        (0, import_jsx_runtime3.jsxs)(Flex, { direction: ["column-reverse", "column-reverse", "row-reverse"], children: [
          (0, import_jsx_runtime3.jsx)(Box, { flex: 1, marginTop: [5, 5, 0], padding: 4, children: (0, import_jsx_runtime3.jsx)(WithReferringDocuments, { documentStore, id: currentAsset._id, children: ({ isLoading, referringDocuments }) => {
            const uniqueReferringDocuments = getUniqueDocuments(referringDocuments);
            return (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
              (0, import_jsx_runtime3.jsxs)(TabList, { space: 2, children: [
                (0, import_jsx_runtime3.jsx)(
                  Tab,
                  {
              ...
              (0, import_jsx_runtime3.jsxs)(Box, { as: "form", marginTop: 4, onSubmit: handleSubmit(onSubmit), children: [
                !assetItem && (0, import_jsx_runtime3.jsx)(Card, { marginBottom: 3, padding: 3, radius: 2, shadow: 1, tone: "critical", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: "This file cannot be found – it may have been deleted." }) }),
                (0, import_jsx_runtime3.jsx)("button", { style: { display: "none" }, tabIndex: -1, type: "submit" }),
                (0, import_jsx_runtime3.jsx)(
                  TabPanel,
                  {
                    ...
                    id: "details-panel",
                    children: CustomDetails ? (0, import_jsx_runtime3.jsx)(
                      CustomDetails,
                      {
                        ...detailsProps,
                        renderDefaultDetails
                      }
                    ) : (0, import_jsx_runtime3.jsx)(Details, { ...detailsProps })
                  }
                ),
                (0, import_jsx_runtime3.jsx)(
                  TabPanel,
                  {
                    ...
                    id: "references-panel",
                    children: (0, import_jsx_runtime3.jsx)(Box, { marginTop: 5, children: assetItem?.asset && (0, import_jsx_runtime3.jsx)(
                      DocumentList,
                      {
          ...
          (0, import_jsx_runtime3.jsxs)(Box, { flex: 1, padding: 4, children: [
            (0, import_jsx_runtime3.jsxs)(Box, { style: { aspectRatio: "1" }, children: [
              isFileAsset(currentAsset) && (0, import_jsx_runtime3.jsx)(FileAssetPreview, { asset: currentAsset }),
              isImageAsset(currentAsset) && (0, import_jsx_runtime3.jsx)(
                Image$1,
                {
                  draggable: false,
                  $scheme: scheme,
            ...
            currentAsset && (0, import_jsx_runtime3.jsx)(Box, { marginTop: 4, children: (0, import_jsx_runtime3.jsx)(AssetMetadata, { asset: currentAsset, item: assetItem }) })
          ] })
        ] }),
        children
      ]
...
var DialogConfirm = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(
    ...
    {
      animate: true,
      footer: (0, import_jsx_runtime3.jsx)(() => (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsxs)(Flex, { justify: "space-between", children: [
        (0, import_jsx_runtime3.jsx)(Button, { fontSize: 1, mode: "bleed", onClick: handleClose, text: "Cancel" }),
        (0, import_jsx_runtime3.jsx)(
          Button,
          {
            fontSize: 1,
      ...
      header: (0, import_jsx_runtime3.jsx)(() => (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", children: [
        (0, import_jsx_runtime3.jsx)(Box, { paddingX: 1, children: (0, import_jsx_runtime3.jsx)(WarningOutlineIcon, {}) }),
        (0, import_jsx_runtime3.jsx)(Box, { marginLeft: 2, children: dialog?.headerTitle })
      ] }), {}),
      id: "confirm",
      onClose: handleClose,
      width: 1,
      children: [
        (0, import_jsx_runtime3.jsx)(Box, { paddingX: 4, paddingY: 4, children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
          dialog?.title && (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: dialog.title }),
          dialog?.description && (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime3.jsx)("em", { children: dialog.description }) })
        ] }) }),
        children
      ]
    }
...
var DialogSearchFacets = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Dialog2, { animate: true, header: "Filters", id, onClose: handleClose, width: 1, children: [
    (0, import_jsx_runtime3.jsxs)(Box, { padding: 3, children: [
      (0, import_jsx_runtime3.jsx)(SearchFacets, { layout: "stack" }),
      (0, import_jsx_runtime3.jsx)(SearchFacetsControl, {})
    ] }),
    children
  ] });
...
var DialogTagCreate = (props) => {
  ...
  return (0, import_react17.useEffect)(() => {
  ...
  }, [creatingError, setError]), (0, import_jsx_runtime3.jsxs)(Dialog2, { animate: true, footer: (0, import_jsx_runtime3.jsx)(() => (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsx)(Flex, { justify: "flex-end", children: (0, import_jsx_runtime3.jsx)(
    FormSubmitButton,
    {
      disabled: formUpdating || !isDirty2 || !isValid3,
      isValid: isValid3,
    ...
    (0, import_jsx_runtime3.jsxs)(Box, { as: "form", padding: 4, onSubmit: handleSubmit(onSubmit), children: [
      (0, import_jsx_runtime3.jsx)("button", { style: { display: "none" }, tabIndex: -1, type: "submit" }),
      (0, import_jsx_runtime3.jsx)(
        FormFieldInputText,
        {
...
var DialogTagEdit = (props) => {
  const {
    children,
    dialog: { id, tagId }
  } = props, client = useVersionedClient(), dispatch = useDispatch(), tagItem = useTypedSelector((state) => selectTagById(state, String(tagId))), [tagSnapshot, setTagSnapshot] = (0, import_react17.useState)(tagItem?.tag), currentTag = tagItem ? tagItem?.tag : tagSnapshot, generateDefaultValues = (tag) => ({
  ...
  return (0, import_react17.useEffect)(() => {
  ...
  }, [client, handleTagUpdate, tagItem?.tag]), currentTag ? (0, import_jsx_runtime3.jsxs)(Dialog2, { animate: true, footer: (0, import_jsx_runtime3.jsx)(() => (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsxs)(Flex, { justify: "space-between", children: [
    (0, import_jsx_runtime3.jsx)(
      Button,
      {
        disabled: formUpdating,
    ...
    (0, import_jsx_runtime3.jsxs)(Box, { as: "form", padding: 4, onSubmit: handleSubmit(onSubmit), children: [
      !tagItem && (0, import_jsx_runtime3.jsx)(Card, { marginBottom: 3, padding: 3, radius: 2, shadow: 1, tone: "critical", children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: "This tag cannot be found – it may have been deleted." }) }),
      (0, import_jsx_runtime3.jsx)("button", { style: { display: "none" }, tabIndex: -1, type: "submit" }),
      (0, import_jsx_runtime3.jsx)(
        FormFieldInputText,
        {
...
var TagContainer = ut(Flex)`
  height: ${PANEL_HEIGHT}px;
`;
var ButtonContainer = ut(Flex)`
  @media (pointer: fine) {
    visibility: hidden;
  }
...
var TagButton = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(
    ...
    {
      animate: true,
      content: (0, import_jsx_runtime3.jsx)(Container, { padding: 2, width: 0, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: tooltip }) }),
      disabled: "ontouchstart" in window,
      placement: "top",
      portal: true,
      children: (0, import_jsx_runtime3.jsx)(
...
var Tag = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(TagContainer, { align: "center", flex: 1, justify: "space-between", paddingLeft: 3, children: [
    (0, import_jsx_runtime3.jsx)(Box, { flex: 1, children: (0, import_jsx_runtime3.jsx)(
      Text,
      {
        muted: true,
        size: 1,
    ...
    (0, import_jsx_runtime3.jsxs)(ButtonContainer, { align: "center", style: { flexShrink: 0 }, children: [
      actions?.includes("search") && (0, import_jsx_runtime3.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
          icon: isSearchFacetTag ? (0, import_jsx_runtime3.jsx)(CloseIcon, {}) : (0, import_jsx_runtime3.jsx)(SearchIcon, {}),
      ...
      actions?.includes("edit") && (0, import_jsx_runtime3.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
          icon: (0, import_jsx_runtime3.jsx)(EditIcon, {}),
          onClick: handleShowTagEditDialog,
          tone: "primary",
          tooltip: "Edit tag"
        }
      ),
      actions?.includes("applyAll") && (0, import_jsx_runtime3.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
          icon: (0, import_jsx_runtime3.jsx)(ArrowUpIcon, {}),
          onClick: handleShowAddTagToAssetsDialog,
          tone: "primary",
          tooltip: "Add tag to selected assets"
        }
      ),
      actions?.includes("removeAll") && (0, import_jsx_runtime3.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
          icon: (0, import_jsx_runtime3.jsx)(ArrowDownIcon, {}),
          onClick: handleShowRemoveTagFromAssetsDialog,
          tone: "critical",
          tooltip: "Remove tag from selected assets"
        }
      ),
      actions?.includes("delete") && (0, import_jsx_runtime3.jsx)(
        TagButton,
        {
          disabled: tag?.updating,
          icon: (0, import_jsx_runtime3.jsx)(TrashIcon, {}),
...
var VirtualRow$1 = (0, import_react17.memo)(
  ({
    isScrolling,
    item
  }) => typeof item == "string" ? (0, import_jsx_runtime3.jsx)(
    Flex,
    {
      align: "center",
      justify: "space-between",
      ...
      children: (0, import_jsx_runtime3.jsx)(Label, { size: 0, children: item })
    },
    item
  ) : (0, import_jsx_runtime3.jsx)(Tag, { actions: isScrolling ? void 0 : item.actions, tag: item }, item.tag?._id)
);
var TagsVirtualized = () => {
  const assetsPicked = useTypedSelector(selectAssetsPicked), tags = useTypedSelector(selectTags), [isScrolling, setIsScrolling] = (0, import_react17.useState)(false), pickedTagIds = assetsPicked?.reduce((acc, val) => {
  ...
  return assetsPicked.length === 0 ? items = tags.map((tagItem) => ({
    ...
    qr,
    {
      ...
      itemContent: (index2) => (0, import_jsx_runtime3.jsx)(VirtualRow$1, { isScrolling, item: items[index2] }),
...
var TagViewHeader = ({ allowCreate, light, title }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: (0, import_jsx_runtime3.jsxs)(
    Flex,
    {
      align: "center",
      justify: "space-between",
      ...
      children: [
        (0, import_jsx_runtime3.jsxs)(Inline, { space: 2, children: [
          (0, import_jsx_runtime3.jsx)(Label, { size: 0, children: title }),
          tagsFetching && (0, import_jsx_runtime3.jsx)(Label, { size: 0, style: { opacity: 0.3 }, children: "Loading..." })
        ] }),
        allowCreate && (0, import_jsx_runtime3.jsx)(Box, { marginRight: 1, children: (0, import_jsx_runtime3.jsx)(
          Button,
          {
...
var TagView = () => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", flex: 1, height: "fill", children: [
    (0, import_jsx_runtime3.jsx)(
      TagViewHeader,
      {
        allowCreate: true,
    ...
    fetchComplete && !hasTags && (0, import_jsx_runtime3.jsx)(Box, { padding: 3, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, children: (0, import_jsx_runtime3.jsx)("em", { children: "No tags" }) }) }),
    hasTags && (0, import_jsx_runtime3.jsx)(TagsVirtualized, {})
  ] });
};
var DialogTags = (props) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Dialog2, { animate: true, header: "All Tags", id, onClose: handleClose, width: 1, children: [
    (0, import_jsx_runtime3.jsx)(
      Box,
      {
        style: {
        ...
        children: (0, import_jsx_runtime3.jsx)(TagView, {})
      }
    ),
    children
  ] });
...
var Dialogs = () => {
  const currentDialogs = useTypedSelector((state) => state.dialog.items), renderDialogs = (dialogs, index2) => {
    ...
    return dialog.type === "assetEdit" ? (0, import_jsx_runtime3.jsx)(DialogAssetEdit, { dialog, children: childDialogs }, index2) : dialog.type === "confirm" ? (0, import_jsx_runtime3.jsx)(DialogConfirm, { dialog, children: childDialogs }, index2) : dialog.type === "searchFacets" ? (0, import_jsx_runtime3.jsx)(DialogSearchFacets, { dialog, children: childDialogs }, index2) : dialog.type === "tagCreate" ? (0, import_jsx_runtime3.jsx)(DialogTagCreate, { dialog, children: childDialogs }, index2) : dialog.type === "tagEdit" ? (0, import_jsx_runtime3.jsx)(DialogTagEdit, { dialog, children: childDialogs }, index2) : dialog.type === "tags" ? (0, import_jsx_runtime3.jsx)(DialogTags, { dialog, children: childDialogs }, index2) : null;
  };
...
var DropzoneDispatchProvider = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(DropzoneDispatchContext.Provider, { value: contextValue, children });
};
...
var Header = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Box, { paddingY: 2, children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", justify: "space-between", children: [
    (0, import_jsx_runtime3.jsx)(Box, { flex: 1, marginX: 3, children: (0, import_jsx_runtime3.jsxs)(Inline, { style: { whiteSpace: "nowrap" }, children: [
      (0, import_jsx_runtime3.jsx)(Text, { textOverflow: "ellipsis", weight: "semibold", children: (0, import_jsx_runtime3.jsx)("span", { children: onSelect ? `Insert ${assetTypes.join(" or ")}` : "Browse Assets" }) }),
      selectedDocument && (0, import_jsx_runtime3.jsx)(Box, { display: ["none", "none", "block"], children: (0, import_jsx_runtime3.jsxs)(Text, { children: [
        (0, import_jsx_runtime3.jsx)("span", { style: { margin: "0 0.5em" }, children: (0, import_jsx_runtime3.jsx)(Icon, { symbol: "arrow-right" }) }),
        (0, import_jsx_runtime3.jsx)("span", { style: { textTransform: "capitalize" }, children: selectedDocument._type })
      ] }) })
    ] }) }),
    (0, import_jsx_runtime3.jsxs)(Flex, { marginX: 2, children: [
      directUploads && (0, import_jsx_runtime3.jsx)(
        Button,
        {
          fontSize: 1,
          icon: UploadIcon,
      ...
      onClose && (0, import_jsx_runtime3.jsx)(Box, { style: { flexShrink: 0 }, children: (0, import_jsx_runtime3.jsx)(
        Button,
        {
          disabled: !onClose,
          icon: CloseIcon,
...
var CardWrapper$1 = ut(Flex)`
  ...
  width: 100%;
`;
var CardContainer = ut(Flex)(
  ({ $picked, theme, $updating }) => it`
...
var ContextActionContainer$2 = ut(Flex)(
  ({ $scheme }) => it`
      cursor: pointer;
      height: ${PANEL_HEIGHT}px;
      transition: all 300ms;
...
var StyledWarningOutlineIcon = ut(WarningFilledIcon)(({ theme }) => ({
  color: theme.sanity.color.spot.red
}));
var CardAsset$1 = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(CardWrapper$1, { padding: 1, children: (0, import_jsx_runtime3.jsxs)(CardContainer, { direction: "column", $picked: picked, $updating: item.updating, children: [
    (0, import_jsx_runtime3.jsxs)(
      Box,
      {
        ...
        children: [
          (0, import_jsx_runtime3.jsxs)("div", { onClick: handleAssetClick, style: { height: "100%", opacity: opacityPreview }, children: [
            isFileAsset(asset) && (0, import_jsx_runtime3.jsx)(FileIcon3, { extension: asset.extension, width: "80px" }),
            isImageAsset(asset) && (0, import_jsx_runtime3.jsx)(
              Image$1,
              {
                draggable: false,
                $scheme: scheme,
          ...
          selected && !updating && (0, import_jsx_runtime3.jsx)(
            Flex,
            {
              align: "center",
              justify: "center",
              ...
              children: (0, import_jsx_runtime3.jsx)(Text, { size: 2, children: (0, import_jsx_runtime3.jsx)(CheckmarkCircleIcon, {}) })
            }
          ),
          updating && (0, import_jsx_runtime3.jsx)(
            Flex,
            {
              align: "center",
              justify: "center",
    ...
    (0, import_jsx_runtime3.jsxs)(
      ContextActionContainer$2,
      {
        ...
        children: [
          onSelect ? (0, import_jsx_runtime3.jsx)(
            EditIcon,
            {
              style: {
                flexShrink: 0,
          ...
          (0, import_jsx_runtime3.jsx)(Box, { marginLeft: 2, children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 0, textOverflow: "ellipsis", children: asset.originalFilename }) })
        ]
      }
    ),
    error && (0, import_jsx_runtime3.jsx)(
      Box,
      {
        padding: 3,
        style: {
        ...
        children: (0, import_jsx_runtime3.jsx)(
          ...
          {
            animate: true,
            content: (0, import_jsx_runtime3.jsx)(Container, { padding: 2, width: 0, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: error }) }),
            placement: "left",
            portal: true,
            children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(StyledWarningOutlineIcon, { color: "critical" }) })
          }
        )
      }
    )
...
var CardAsset = (0, import_react17.memo)(CardAsset$1);
...
var hexFromBuffer = (buffer) => Array.prototype.map.call(new Uint8Array(buffer), (x2) => `00${x2.toString(16)}`.slice(-2)).join("");
      ...
      of(null).pipe(
        ...
        takeUntil(
          action$.pipe(
            ...
            filter((v3) => v3.payload.hash === uploadItem.hash)
          )
        ),
...
var CardUpload = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(CardWrapper, { padding: 1, children: (0, import_jsx_runtime3.jsxs)(
    Flex,
    {
      direction: "column",
      flex: 1,
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsxs)(Box, { flex: 1, style: { position: "relative" }, children: [
          item.assetType === "image" && item?.objectUrl && (0, import_jsx_runtime3.jsx)(
            Image$1,
            {
              draggable: false,
              $scheme: scheme,
          ...
          item.assetType === "file" && (0, import_jsx_runtime3.jsx)("div", { style: { height: "100%", opacity: 0.1 }, children: (0, import_jsx_runtime3.jsx)(FileIcon3, { width: "80px" }) }),
          !isComplete && percentLoaded !== 100 && (0, import_jsx_runtime3.jsx)(
            Flex,
            {
              align: "center",
              direction: "column",
        ...
        (0, import_jsx_runtime3.jsxs)(
          Flex,
          {
            ...
            style: { height: `${PANEL_HEIGHT}px` },
            children: [
              (0, import_jsx_runtime3.jsx)(Box, { flex: 1, marginRight: 1, children: (0, import_jsx_runtime3.jsxs)(Text, { size: 0, textOverflow: "ellipsis", children: [
                item.name,
                " (",
                fileSize,
                ")"
              ] }) }),
              (0, import_jsx_runtime3.jsx)(Text, { size: 0, style: { flexShrink: 0 }, weight: "semibold", children: status })
            ]
          }
        )
      ]
...
var VirtualCell = (0, import_react17.memo)(
  ({ item, selected }) => item?.type === "asset" ? (0, import_jsx_runtime3.jsx)(CardAsset, { id: item.id, selected }) : item?.type === "upload" ? (0, import_jsx_runtime3.jsx)(CardUpload, { id: item.id }) : null
);
var StyledItemContainer = ut.div`
  height: ${CARD_HEIGHT}px;
  width: ${CARD_WIDTH}px;
`;
var ItemContainer = (0, import_react17.forwardRef)((props, ref) => {
  const { context, ...rest } = props;
  return (0, import_jsx_runtime3.jsx)(StyledItemContainer, { ref, ...rest });
});
var StyledListContainer = ut.div`
  display: grid;
  ...
  margin: 0 auto;
`;
var ListContainer = (0, import_react17.forwardRef)((props, ref) => {
  const { context, ...rest } = props;
  return (0, import_jsx_runtime3.jsx)(StyledListContainer, { ref, ...rest });
});
var AssetGridVirtualized = (props) => {
  ...
  return totalCount === 0 ? null : (0, import_jsx_runtime3.jsx)(
    Jr,
    {
      className: "media__custom-scrollbar",
      ...
      itemContent: (index2) => {
        ...
        return (0, import_jsx_runtime3.jsx)(VirtualCell, { item, selected });
      },
      overscan: 48,
...
var TableHeaderItem = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Label, { muted: !field, size: 0, children: (0, import_jsx_runtime3.jsxs)(
    Box,
    {
      onClick: field ? () => {
        if (!(!field || !title))
      ...
      children: [
        ...
        isActive && order?.direction === "asc" && (0, import_jsx_runtime3.jsx)(ChevronUpIcon, {}),
        isActive && order?.direction === "desc" && (0, import_jsx_runtime3.jsx)(ChevronDownIcon, {})
      ]
    }
  ) });
};
var ContextActionContainer$1 = ut(Flex)(
  ({ $scheme }) => it`
      cursor: pointer;
      @media (hover: hover) and (pointer: fine) {
        &:hover {
...
var TableHeader = () => {
  ...
  return (0, import_jsx_runtime3.jsxs)(
    Grid,
    {
      ...
      children: [
        onSelect ? (0, import_jsx_runtime3.jsx)(TableHeaderItem, {}) : (0, import_jsx_runtime3.jsx)(
        ...
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, {}),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, { field: "originalFilename", title: "Filename" }),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, { title: "Resolution" }),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, { field: "mimeType", title: "MIME type" }),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, { field: "size", title: "Size" }),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, { field: "_updatedAt", title: "Last updated" }),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, { title: "References" }),
        (0, import_jsx_runtime3.jsx)(TableHeaderItem, {})
      ]
    }
  );
...
var ContainerGrid = ut(Grid)(({ $scheme, $selected, $updating }) => it`
    align-items: center;
    cursor: ${$selected ? "default" : "pointer"};
    height: 100%;
    pointer-events: ${$updating ? "none" : "auto"};
    ...
    `}
  `);
var ContextActionContainer = ut(Flex)(
  ({ $scheme }) => it`
      cursor: pointer;
      @media (hover: hover) and (pointer: fine) {
        &:hover {
...
var StyledWarningIcon = ut(WarningFilledIcon)(({ theme }) => ({
  color: theme.sanity.color.spot.red
}));
var TableRowAsset$1 = (props) => {
  const { id, selected } = props, scheme = useColorSchemeValue(), shiftPressed = useKeyPress("shift"), [referenceCountVisible, setReferenceCountVisible] = (0, import_react17.useState)(false), refCountVisibleTimeout = (0, import_react17.useRef)(null), dispatch = useDispatch(), lastPicked = useTypedSelector((state) => state.assets.lastPicked), item = useTypedSelector((state) => selectAssetById(state, id)), mediaIndex = useMediaIndex(), asset = item?.asset, error = item?.error, isOpaque = item?.asset?.metadata?.isOpaque, picked = item?.picked, updating = item?.updating, { onSelect } = useAssetSourceActions(), handleContextActionClick = (0, import_react17.useCallback)(
    (e2) => {
  ...
  }), []), asset ? (0, import_jsx_runtime3.jsxs)(
    ContainerGrid,
    {
      ...
      children: [
        (0, import_jsx_runtime3.jsx)(
          ContextActionContainer,
          {
            ...
            children: onSelect ? (0, import_jsx_runtime3.jsx)(
              EditIcon,
              {
                style: {
                  flexShrink: 0,
        ...
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", justify: "center", style: { height: "100%", position: "relative" }, children: [
              (0, import_jsx_runtime3.jsxs)(Box, { style: { height: "100%", opacity: opacityPreview, position: "relative" }, children: [
                isFileAsset(asset) && (0, import_jsx_runtime3.jsx)(FileIcon3, { extension: asset.extension, width: "40px" }),
                isImageAsset(asset) && (0, import_jsx_runtime3.jsx)(
                  Image$1,
                  {
                    draggable: false,
        ...
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: { lineHeight: "2em" }, textOverflow: "ellipsis", children: asset.originalFilename })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: { lineHeight: "2em" }, textOverflow: "ellipsis", children: isImageAsset(asset) && getAssetResolution(asset) })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: { lineHeight: "2em" }, textOverflow: "ellipsis", children: asset.mimeType })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: { lineHeight: "2em" }, textOverflow: "ellipsis", children: filesize(asset.size, { base: 10, round: 0 }) })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: { lineHeight: "2em" }, textOverflow: "ellipsis", children: formatRelative(new Date(asset._updatedAt), /* @__PURE__ */ new Date()) })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsx)(Text, { muted: true, size: 1, style: { lineHeight: "2em" }, textOverflow: "ellipsis", children: referenceCountVisible ? (0, import_jsx_runtime3.jsx)(WithReferringDocuments, { id, children: ({ isLoading, referringDocuments }) => {
              const uniqueDocuments = getUniqueDocuments(referringDocuments);
              return isLoading ? (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: "-" }) : (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: Array.isArray(uniqueDocuments) ? uniqueDocuments.length : 0 });
            } }) : (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: "-" }) })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Flex,
          {
            ...
            children: error && (0, import_jsx_runtime3.jsx)(Box, { padding: 2, children: (0, import_jsx_runtime3.jsx)(
              Tooltip,
              {
                animate: true,
                content: (0, import_jsx_runtime3.jsx)(Container, { padding: 2, width: 0, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: error }) }),
                placement: "left",
                portal: true,
                children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, children: (0, import_jsx_runtime3.jsx)(StyledWarningIcon, { color: "critical" }) })
              }
            ) })
          }
        )
...
var TableRowAsset = (0, import_react17.memo)(TableRowAsset$1);
      ...
      children: [
        ...
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsxs)(Box, { style: { height: "100%", position: "relative" }, children: [
              item.assetType === "image" && item?.objectUrl && (0, import_jsx_runtime3.jsx)(
                Image$1,
                {
                  draggable: false,
              ...
              item.assetType === "file" && (0, import_jsx_runtime3.jsx)("div", { style: { height: "100%", opacity: 0.1 }, children: (0, import_jsx_runtime3.jsx)(FileIcon3, { width: "40px" }) }),
              !isComplete && percentLoaded !== 100 && (0, import_jsx_runtime3.jsx)(
                Flex,
                {
                  align: "center",
        ...
        (0, import_jsx_runtime3.jsx)(
          Box,
          {
            ...
            children: (0, import_jsx_runtime3.jsxs)(Stack, { space: 3, children: [
              (0, import_jsx_runtime3.jsxs)(Text, { muted: true, size: 1, textOverflow: "ellipsis", children: [
                item.name,
                " (",
                fileSize,
                ")"
              ] }),
              (0, import_jsx_runtime3.jsx)(Text, { size: 1, textOverflow: "ellipsis", weight: "semibold", children: status })
            ] })
          }
        )
      ]
...
var VirtualRow = (0, import_react17.memo)(
  ({ item, selected }) => item?.type === "asset" ? (0, import_jsx_runtime3.jsx)(Box, { style: { height: "100px" }, children: (0, import_jsx_runtime3.jsx)(TableRowAsset, { id: item.id, selected }) }) : item?.type === "upload" ? (0, import_jsx_runtime3.jsx)(Box, { style: { height: "100px" }, children: (0, import_jsx_runtime3.jsx)(TableRowUpload, { id: item.id }) }) : null
);
var AssetTableVirtualized = (props) => {
  ...
  return totalCount === 0 ? null : (0, import_jsx_runtime3.jsx)(
    Yr,
    {
      ...
      groupContent: () => (0, import_jsx_runtime3.jsx)(TableHeader, {}),
      itemContent: (index2) => {
        const item = items[index2], selected = selectedIds.includes(item?.id);
        return (0, import_jsx_runtime3.jsx)(VirtualRow, { item, selected });
      },
...
var Items = () => {
  ...
  }, [breakpointIndex]), (0, import_jsx_runtime3.jsx)(Box, { flex: 1, style: { width: "100%" }, children: !hasItems && hasFetchedOnce && !fetching ? (0, import_jsx_runtime3.jsx)(Box, { padding: 4, children: (0, import_jsx_runtime3.jsx)(Text, { size: 1, weight: "semibold", children: "No results for the current query" }) }) : (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    view === "grid" && (0, import_jsx_runtime3.jsx)(AssetGridVirtualized, { items: combinedItems, onLoadMore: handleLoadMoreItems }),
    view === "table" && (0, import_jsx_runtime3.jsx)(AssetTableVirtualized, { items: combinedItems, onLoadMore: handleLoadMoreItems })
  ] }) });
};
var Notifications = () => {
...
var PickedBar = () => {
  ...
  return assetsPicked.length === 0 ? null : (0, import_jsx_runtime3.jsx)(
    Flex,
    {
      align: "center",
      justify: "flex-start",
      ...
      children: (0, import_jsx_runtime3.jsxs)(Flex, { align: "center", paddingX: 3, children: [
        (0, import_jsx_runtime3.jsx)(Box, { paddingRight: 2, children: (0, import_jsx_runtime3.jsxs)(Label, { size: 0, style: { color: "inherit" }, children: [
          assetsPicked.length,
          " ",
        ...
        (0, import_jsx_runtime3.jsx)(
          Button,
          {
            ...
            style: { background: "none", boxShadow: "none" },
            tone: "default",
            children: (0, import_jsx_runtime3.jsx)(Label, { size: 0, children: "Deselect" })
          }
        ),
        (0, import_jsx_runtime3.jsx)(
          Button,
          {
            ...
            style: { background: "none", boxShadow: "none" },
            tone: "critical",
            children: (0, import_jsx_runtime3.jsx)(Label, { size: 0, children: "Delete" })
          }
        )
      ] })
    }
...
var getAssetIds = (node2, acc = []) => (Array.isArray(node2) && node2.forEach((v3) => {
  getAssetIds(v3, acc);
}), isPlainObject4(node2) && (node2?.asset?._type === "reference" && node2?.asset?._ref && acc.push(node2.asset._ref), Object.values(node2).forEach((val) => {
  getAssetIds(val, acc);
})), acc);
...
function isSupportedAssetType(assetType) {
  return assetType ? SUPPORTED_ASSET_TYPES.includes(assetType) : false;
}
var ReduxProvider = class extends import_react17.Component {
  ...
  render() {
    return (0, import_jsx_runtime3.jsx)(Provider_default, { store: this.store, children: this.props.children });
  }
};
var TagsPanel = () => useTypedSelector((state) => state.tags.panelVisible) ? (0, import_jsx_runtime3.jsx)(
  Box,
  {
    style: {
      position: "relative",
...
`;
var DragActiveContainer = ut.div`
  align-items: center;
...
var UploadDropzone = (props) => {
  const { children } = props, {
    ...
    rejections.flatMap(({ errors: errors2 }) => errors2.map(({ code }) => code)).includes("file-too-large") && dispatch(
  ...
  return (0, import_jsx_runtime3.jsx)(DropzoneDispatchProvider, { open, children: (0, import_jsx_runtime3.jsxs)(UploadContainer, { ...getRootProps(), children: [
    (0, import_jsx_runtime3.jsx)("input", { ...getInputProps() }),
    isDragActive && (0, import_jsx_runtime3.jsx)(DragActiveContainer, { children: (0, import_jsx_runtime3.jsx)(Flex, { direction: "column", justify: "center", style: { color: white.hex }, children: (0, import_jsx_runtime3.jsx)(Text, { size: 3, style: { color: "inherit" }, children: "Drop files to upload" }) }) }),
    children
  ] }) });
};
var BrowserContent = ({ onClose }) => {
  ...
  }, [client, dispatch]), (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, children: (0, import_jsx_runtime3.jsxs)(UploadDropzone, { children: [
    (0, import_jsx_runtime3.jsx)(Dialogs, {}),
    (0, import_jsx_runtime3.jsx)(Notifications, {}),
    (0, import_jsx_runtime3.jsx)(Card, { display: "flex", height: "fill", ref: setPortalElement, children: (0, import_jsx_runtime3.jsxs)(Flex, { direction: "column", flex: 1, children: [
      (0, import_jsx_runtime3.jsx)(Header, { onClose }),
      (0, import_jsx_runtime3.jsx)(Controls, {}),
      (0, import_jsx_runtime3.jsxs)(Flex, { flex: 1, children: [
        (0, import_jsx_runtime3.jsxs)(Flex, { align: "flex-end", direction: "column", flex: 1, style: { position: "relative" }, children: [
          (0, import_jsx_runtime3.jsx)(PickedBar, {}),
          (0, import_jsx_runtime3.jsx)(Items, {})
        ] }),
        (0, import_jsx_runtime3.jsx)(TagsPanel, {})
      ] }),
      (0, import_jsx_runtime3.jsx)(DebugControls, {})
    ] }) })
  ] }) });
};
var Browser = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(
    ReduxProvider,
    {
      ...
      children: (0, import_jsx_runtime3.jsxs)(AssetBrowserDispatchProvider, { onSelect: props?.onSelect, children: [
        (0, import_jsx_runtime3.jsx)(GlobalStyle, {}),
        (0, import_jsx_runtime3.jsx)(BrowserContent, { onClose: props?.onClose })
      ] })
    }
  );
};
var FormBuilderTool = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(PortalProvider, { element: portalElement, children: (0, import_jsx_runtime3.jsx)(Portal, { children: (0, import_jsx_runtime3.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime3.jsx)(Browser, { document: currentDocument, ...props })
    }
  ) }) });
};
...
var Tool = () => (0, import_jsx_runtime3.jsx)(Flex, { direction: "column", height: "fill", flex: 1, children: (0, import_jsx_runtime3.jsx)(Browser, {}) });
var mediaTag = {
  title: "Media Tag",
  icon: TagIcon,
...
var media = definePlugin((options2) => ({
  ...
  studio: {
    components: {
      layout: (props) => (0, import_jsx_runtime3.jsx)(ToolOptionsProvider, { options: options2, children: props.renderDefault(props) })
    }
  },
  form: {
    file: {
